...
public class BMPMetadataFormatResources extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        ...
        { "Width", "The width of the image" }, //Audit Issue: User marked 'The width of the image' string as Not an Issue string with comment: ''.
        ...
        { "ColorsImportant",
          "Number of color indexes considered important for display" }, //Audit Issue: User marked 'Number of color indexes considered important for display' string as Not an Issue string with comment: ''.
        { "Mask",
