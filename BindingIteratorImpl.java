...
public abstract class BindingIteratorImpl extends BindingIteratorPOA
{
    ...
    {
        if( how_many == 0 ) {
            throw new BAD_PARAM( " 'how_many' parameter is set to 0 which is" + //Audit Issue: User marked ' 'how_many' parameter is set to 0 which is' string as Not an Issue string with comment: ''.
            " invalid" ); //Audit Issue: User marked ' invalid' string as Not an Issue string with comment: ''.
        }
