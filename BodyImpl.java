...
public abstract class BodyImpl extends ElementImpl implements SOAPBody {
    ...
    public SOAPFault addFault() throws SOAPException {
        if (hasFault()) {
            log.severe("SAAJ0110.impl.fault.already.exists"); //Audit Issue: User marked 'SAAJ0110.impl.fault.already.exists' string as Not an Issue string with comment: ''.
   ...
   public SOAPFault addFault(
    ...
    public void setParentElement(SOAPElement element) throws SOAPException {
        ...
        if (!(element instanceof SOAPEnvelope)) {
            log.severe("SAAJ0111.impl.body.parent.must.be.envelope"); //Audit Issue: User marked 'SAAJ0111.impl.body.parent.must.be.envelope' string as Not an Issue string with comment: ''.
    ...
    public SOAPElement setElementQName(QName newName) throws SOAPException {
        log.log(Level.SEVERE,
                "SAAJ0146.impl.invalid.name.change.requested", //Audit Issue: User marked 'SAAJ0146.impl.invalid.name.change.requested' string as Not an Issue string with comment: ''.
    ...
    public Document extractContentAsDocument() throws SOAPException {
        ...
        if(!exactlyOneChildElement) {
            log.log(Level.SEVERE,
                    "SAAJ0250.impl.body.should.have.exactly.one.child"); //Audit Issue: User marked 'SAAJ0250.impl.body.should.have.exactly.one.child' string as Not an Issue string with comment: ''.
