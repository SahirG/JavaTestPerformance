...
public class _IDLTypeStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.IDLType
{
    ...
    private static String[] __ids = {
        "IDL:omg.org/CORBA/IDLType:1.0", //Audit Issue: User marked 'IDL:omg.org/CORBA/IDLType:1.0' string as Not an Issue string with comment: ''.
        "IDL:omg.org/CORBA/IRObject:1.0"}; //Audit Issue: User marked 'IDL:omg.org/CORBA/IRObject:1.0' string as Not an Issue string with comment: ''.
