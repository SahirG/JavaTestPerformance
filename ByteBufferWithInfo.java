...
public class ByteBufferWithInfo
{
        ...
        if (usePooledByteBuffers)
        {
            ...
            if (debug)
            {
                ...
                sb.append("constructor (ORB, BufferManagerWrite) - got ")
                  .append("ByteBuffer id (").append(bbAddress) //Audit Issue: User marked 'ByteBuffer id (' string as Not an Issue string with comment: ''.
    ...
    public void growBuffer(com.sun.corba.se.spi.orb.ORB orb)
    {
        ...
        if (debug)
        {
            ...
            StringBuffer sb = new StringBuffer(80);
            sb.append("growBuffer() - got ByteBuffer id ("); //Audit Issue: User marked 'growBuffer() - got ByteBuffer id (' string as Not an Issue string with comment: ''.
        ...
        if (debug)
        {
            ...
            int bbAddress = System.identityHashCode(byteBuffer);
            StringBuffer sb = new StringBuffer(80);
            sb.append("growBuffer() - releasing ByteBuffer id ("); //Audit Issue: User marked 'growBuffer() - releasing ByteBuffer id (' string as Not an Issue string with comment: ''.
