...
public class XMLGregorianCalendarImpl
    ...
    protected XMLGregorianCalendarImpl(String lexicalRepresentation)
        ...
        if (!isValid()) {
            throw new IllegalArgumentException(
                    DatatypeMessageFormatter.formatMessage(null, "InvalidXGCRepresentation", new Object[]{lexicalRepresentation}) //Audit Issue: User marked 'InvalidXGCRepresentation' string as Not an Issue string with comment: ''.
        ...
        setTime(hour, minute, second, fractionalSecond);
            ...
            throw new IllegalArgumentException(
                DatatypeMessageFormatter.formatMessage(null,
                    "InvalidXGCValue-fractional", //Audit Issue: User marked 'InvalidXGCValue-fractional' string as Not an Issue string with comment: ''.
    ...
    private XMLGregorianCalendarImpl(
        ...
        setTime(hour, minute, second);
            ...
            throw new IllegalArgumentException(
                DatatypeMessageFormatter.formatMessage(null,
                "InvalidXGCValue-milli", //Audit Issue: User marked 'InvalidXGCValue-milli' string as Not an Issue string with comment: ''.
    ...
    private void invalidFieldValue(int field, int value) {
        throw new IllegalArgumentException(
            DatatypeMessageFormatter.formatMessage(null, "InvalidFieldValue", //Audit Issue: User marked 'InvalidFieldValue' string as Not an Issue string with comment: ''.
    ...
    public QName getXMLSchemaType() {
        ...
        default:
            throw new IllegalStateException(
                ...
                + "#getXMLSchemaType() :"
                + DatatypeMessageFormatter.formatMessage(null, "InvalidXGCFields", null) //Audit Issue: User marked 'InvalidXGCFields' string as Not an Issue string with comment: ''.
            );
        }
    }
    ...
    private static final BigDecimal DECIMAL_ZERO = new BigDecimal("0"); //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
        ...
        if (fractional != null) {
            if ((fractional.compareTo(DECIMAL_ZERO) < 0) ||
                ...
                throw new IllegalArgumentException(DatatypeMessageFormatter.formatMessage(null,
                        "InvalidFractional", new Object[]{fractional})); //Audit Issue: User marked 'InvalidFractional' string as Not an Issue string with comment: ''.
            }
        }
            ...
            case 's':
                ...
                if (getFractionalSecond() != null) {
                    ...
                    if (pos >= 0) {
                        ...
                        if (count < 40) {
                            frac = "00000000000000000000000000000000000000000".substring(0,count-1) + frac; //Audit Issue: User marked '00000000000000000000000000000000000000000' string as Not an Issue string with comment: ''.
                        } else {
                            // do it the hard way
                            while (count > 1) {
                                frac = "0" + frac; //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
                                count--;
                            }
                        }
                        frac = "0." + frac; //Audit Issue: User marked '0.' string as Not an Issue string with comment: ''.
                    }
