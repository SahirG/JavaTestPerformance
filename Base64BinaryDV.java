...
public class Base64BinaryDV extends TypeValidator {
    ...
    public Object getActualValue(String content, ValidationContext context) throws InvalidDatatypeValueException {
        ...
        if (decoded == null)
            throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.1", new Object[]{content, "base64Binary"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.1' string as Not an Issue string with comment: ''.
