                    ...
                    if ( ((fConfiguration.features & DOMConfigurationImpl.WELLFORMED) != 0) &&
                        ...
                        if (!wellformed){
                            String msg = DOMMessageFormatter.formatMessage(
                                    ...
                                    "wf-invalid-character-in-node-name", //Audit Issue: User marked 'wf-invalid-character-in-node-name' string as Not an Issue string with comment: ''.
            ...
            while(i < datalength){
                ...
                if ( XML11Char.isXML11Invalid(c) ) {
                    ...
                    String msg = DOMMessageFormatter.formatMessage(
                        ...
                        "InvalidCharInCDSect", //Audit Issue: User marked 'InvalidCharInCDSect' string as Not an Issue string with comment: ''.
                    ...
                    reportDOMError(
                        ...
                        "wf-invalid-character"); //Audit Issue: User marked 'wf-invalid-character' string as Not an Issue string with comment: ''.
                }
                else if (c == ']') {
                    int count = i;
                    if (count < datalength && dataarray[count] == ']') {
                        ...
                        if (count < datalength && dataarray[count] == '>') {
                            ...
                            reportDOMError(errorHandler, error, locator,msg, DOMError.SEVERITY_ERROR, "wf-invalid-character"); //Audit Issue: User marked 'wf-invalid-character' string as Not an Issue string with comment: ''.
                        }
                    }
        ...
        if(isXML11Version){
            ...
            while (i < datalength) {
                if(XML11Char.isXML11Invalid(dataarray[i++])){
                    ...
                    String msg = DOMMessageFormatter.formatMessage(
                        DOMMessageFormatter.DOM_DOMAIN, "InvalidXMLCharInDOM", //Audit Issue: User marked 'InvalidXMLCharInDOM' string as Not an Issue string with comment: ''.
        ...
        if (isXML11Version) {
            ...
            while (i < datalength){
                ...
                if ( XML11Char.isXML11Invalid(c) ) {
                    ...
                    String msg = DOMMessageFormatter.formatMessage(DOMMessageFormatter.XML_DOMAIN,
                        "InvalidCharInComment", //Audit Issue: User marked 'InvalidCharInComment' string as Not an Issue string with comment: ''.
                        new Object [] {Integer.toString(dataarray[i-1], 16)});
                    reportDOMError(errorHandler, error, locator, msg, DOMError.SEVERITY_ERROR, "wf-invalid-character"); //Audit Issue: User marked 'wf-invalid-character' string as Not an Issue string with comment: ''.
                }
            ...
            while (i < datalength){
                ...
                if( XMLChar.isInvalid(c) ){
                    ...
                    String msg = DOMMessageFormatter.formatMessage(DOMMessageFormatter.XML_DOMAIN,
                        "InvalidCharInComment", new Object [] {Integer.toString(dataarray[i-1], 16)}); //Audit Issue: User marked 'InvalidCharInComment' string as Not an Issue string with comment: ''.
                    reportDOMError(errorHandler, error, locator, msg, DOMError.SEVERITY_ERROR, "wf-invalid-character"); //Audit Issue: User marked 'wf-invalid-character' string as Not an Issue string with comment: ''.
                }
                else if (c == '-' && i<datalength && dataarray[i]=='-'){
                    String msg = DOMMessageFormatter.formatMessage(DOMMessageFormatter.XML_DOMAIN,
