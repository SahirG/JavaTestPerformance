...
public class XSSimpleTypeDecl implements XSSimpleType, TypeInfo {
    ...
    static final String URI_SCHEMAFORSCHEMA = "http://www.w3.org/2001/XMLSchema"; //Audit Issue: User marked 'http://www.w3.org/2001/XMLSchema' string as Not an Issue string with comment: ''.
        ...
        if ((presentFacet & FACET_PATTERN) != 0) {
            if ((allowedFacet & FACET_PATTERN) == 0) {
                ...
                try {
                    ...
                    reportError("InvalidRegex", new Object[]{facets.pattern, e.getLocalizedMessage()}); //Audit Issue: User marked 'InvalidRegex' string as Not an Issue string with comment: ''.
                }
                if (regex != null) {
                    fPattern = new Vector();
            ...
            if ((allowedFacet & FACET_ENUMERATION) == 0) {
                ...
                for (int i = 0; i < enumVals.size(); i++) {
                    ...
                    try {
                        ...
                        reportError("enumeration-valid-restriction", new Object[]{enumVals.elementAt(i), this.getBaseType().getName()}); //Audit Issue: User marked 'enumeration-valid-restriction' string as Not an Issue string with comment: ''.
                    }
                }
            ...
            if ((allowedFacet & FACET_MAXEXCLUSIVE) == 0) {
                ...
                // maxExclusive <= base.maxInclusive
                    ...
                    if (fDVs[fValidationDV].compare(fMaxExclusive, fBase.fMaxInclusive) > 0) {
                        reportError( "maxExclusive-valid-restriction.2", new Object[]{facets.maxExclusive, fBase.fMaxInclusive}); //Audit Issue: User marked 'maxExclusive-valid-restriction.2' string as Not an Issue string with comment: ''.
                    }
                }
            }
        }
            ...
            if ((allowedFacet & FACET_MINEXCLUSIVE) == 0) {
                ...
                // minExclusive >= base.minInclusive
                    ...
                    if (fDVs[fValidationDV].compare(fMinExclusive, fBase.fMinInclusive) < 0) {
                        reportError( "minExclusive-valid-restriction.3", new Object[]{facets.minExclusive, fBase.fMinInclusive}); //Audit Issue: User marked 'minExclusive-valid-restriction.3' string as Not an Issue string with comment: ''.
                    }
                }
            }
        }
        ...
        if(fFacetsDefined != 0) {
            ...
            if((fFacetsDefined & FACET_LENGTH) != 0 ){
                ...
                if ( (fBase.fFacetsDefined & FACET_LENGTH) != 0 ) {
                    ...
                    if ( fLength != fBase.fLength )
                        reportError( "length-valid-restriction", new Object[]{Integer.toString(fLength), Integer.toString(fBase.fLength), fTypeName}); //Audit Issue: User marked 'length-valid-restriction' string as Not an Issue string with comment: ''.
                }
            }
            ...
            if ( ((fFacetsDefined & FACET_MINLENGTH ) != 0 ) ) {
                if ( (fBase.fFacetsDefined & FACET_MAXLENGTH ) != 0 ) {
                    ...
                    if ( fMinLength < fBase.fMinLength ) {
                        reportError( "minLength-valid-restriction", new Object[]{Integer.toString(fMinLength), Integer.toString(fBase.fMinLength), fTypeName}); //Audit Issue: User marked 'minLength-valid-restriction' string as Not an Issue string with comment: ''.
                    }
                }
            }
            ...
            if ( (fFacetsDefined & FACET_MAXLENGTH) != 0 ) {
                if ( (fBase.fFacetsDefined & FACET_MAXLENGTH) != 0 ){
                    ...
                    if ( fMaxLength > fBase.fMaxLength ) {
                        reportError( "maxLength-valid-restriction", new Object[]{Integer.toString(fMaxLength), Integer.toString(fBase.fMaxLength), fTypeName}); //Audit Issue: User marked 'maxLength-valid-restriction' string as Not an Issue string with comment: ''.
                    }
                }
            }
            ...
            if (((fFacetsDefined & FACET_TOTALDIGITS) != 0)) {
                if ((( fBase.fFacetsDefined & FACET_TOTALDIGITS) != 0)) {
                    ...
                    if (fTotalDigits > fBase.fTotalDigits) {
                        reportError( "totalDigits-valid-restriction", new Object[]{Integer.toString(fTotalDigits), Integer.toString(fBase.fTotalDigits), fTypeName}); //Audit Issue: User marked 'totalDigits-valid-restriction' string as Not an Issue string with comment: ''.
                    }
                }
            }
            ...
            if (((fFacetsDefined & FACET_FRACTIONDIGITS) != 0)) {
                if ((( fBase.fFacetsDefined & FACET_FRACTIONDIGITS) != 0)) {
                    ...
                    if (fFractionDigits > fBase.fFractionDigits) {
                        reportError( "fractionDigits-valid-restriction", new Object[]{Integer.toString(fFractionDigits), Integer.toString(fBase.fFractionDigits), fTypeName}); //Audit Issue: User marked 'fractionDigits-valid-restriction' string as Not an Issue string with comment: ''.
                    }
                }
                else if (fValidationDV == DV_INTEGER && fFractionDigits != 0) {
                    reportError("FixedFacetValue", new Object[]{"fractionDigits", Integer.toString(fFractionDigits), "0", fTypeName}); //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
                }
            }
            ...
            if ( (fFacetsDefined & FACET_WHITESPACE) != 0 && (fBase.fFacetsDefined & FACET_WHITESPACE) != 0 ){
                ...
                if ( fWhiteSpace == WS_PRESERVE &&  fBase.fWhiteSpace == WS_COLLAPSE ){
                    reportError( "whiteSpace-valid-restriction.1", new Object[]{fTypeName, "preserve"}); //Audit Issue: User marked 'whiteSpace-valid-restriction.1' string as Not an Issue string with comment: ''.
                }
                if ( fWhiteSpace == WS_REPLACE &&  fBase.fWhiteSpace == WS_COLLAPSE ){
                    reportError( "whiteSpace-valid-restriction.1", new Object[]{fTypeName, "replace"}); //Audit Issue: User marked 'whiteSpace-valid-restriction.1' string as Not an Issue string with comment: ''.
                }
                if ( fWhiteSpace == WS_PRESERVE &&  fBase.fWhiteSpace == WS_REPLACE ){
                    reportError( "whiteSpace-valid-restriction.2", new Object[]{fTypeName}); //Audit Issue: User marked 'whiteSpace-valid-restriction.2' string as Not an Issue string with comment: ''.
                }
            }
        }//fFacetsDefined != null
    ...
    private void checkFacets(ValidatedInfo validatedInfo) throws InvalidDatatypeValueException {
        ...
        if (fValidationDV != DV_QNAME && fValidationDV != DV_NOTATION) {
            ...
            if ( (fFacetsDefined & FACET_MAXLENGTH) != 0 ) {
                if ( length > fMaxLength ) {
                    throw new InvalidDatatypeValueException("cvc-maxLength-valid", //Audit Issue: User marked 'cvc-maxLength-valid' string as Not an Issue string with comment: ''.
            ...
            if ( (fFacetsDefined & FACET_MINLENGTH) != 0 ) {
                if ( length < fMinLength ) {
                    throw new InvalidDatatypeValueException("cvc-minLength-valid", //Audit Issue: User marked 'cvc-minLength-valid' string as Not an Issue string with comment: ''.
            ...
            if ( (fFacetsDefined & FACET_LENGTH) != 0 ) {
                if ( length != fLength ) {
                    throw new InvalidDatatypeValueException("cvc-length-valid", //Audit Issue: User marked 'cvc-length-valid' string as Not an Issue string with comment: ''.
        ...
        if ( ((fFacetsDefined & FACET_ENUMERATION) != 0 ) ) {
            ...
            if(!present){
                throw new InvalidDatatypeValueException("cvc-enumeration-valid", //Audit Issue: User marked 'cvc-enumeration-valid' string as Not an Issue string with comment: ''.
        ...
        if ((fFacetsDefined & FACET_FRACTIONDIGITS) != 0) {
            ...
            if (scale > fFractionDigits) {
                throw new InvalidDatatypeValueException("cvc-fractionDigits-valid", //Audit Issue: User marked 'cvc-fractionDigits-valid' string as Not an Issue string with comment: ''.
        ...
        if ((fFacetsDefined & FACET_TOTALDIGITS)!=0) {
            ...
            if (totalDigits > fTotalDigits) {
                throw new InvalidDatatypeValueException("cvc-totalDigits-valid", //Audit Issue: User marked 'cvc-totalDigits-valid' string as Not an Issue string with comment: ''.
        ...
        if ( (fFacetsDefined & FACET_MAXINCLUSIVE) != 0 ) {
            ...
            if (compare != -1 && compare != 0) {
                throw new InvalidDatatypeValueException("cvc-maxInclusive-valid", //Audit Issue: User marked 'cvc-maxInclusive-valid' string as Not an Issue string with comment: ''.
        ...
        if ( (fFacetsDefined & FACET_MAXEXCLUSIVE) != 0 ) {
            ...
            if (compare != -1) {
                throw new InvalidDatatypeValueException("cvc-maxExclusive-valid", //Audit Issue: User marked 'cvc-maxExclusive-valid' string as Not an Issue string with comment: ''.
        ...
        if ( (fFacetsDefined & FACET_MININCLUSIVE) != 0 ) {
            ...
            if (compare != 1 && compare != 0) {
                throw new InvalidDatatypeValueException("cvc-minInclusive-valid", //Audit Issue: User marked 'cvc-minInclusive-valid' string as Not an Issue string with comment: ''.
        ...
        if ( (fFacetsDefined & FACET_MINEXCLUSIVE) != 0 ) {
            ...
            if (compare != 1) {
                throw new InvalidDatatypeValueException("cvc-minExclusive-valid", //Audit Issue: User marked 'cvc-minExclusive-valid' string as Not an Issue string with comment: ''.
    ...
    throws InvalidDatatypeValueException{
        ...
        if ( (fFacetsDefined & FACET_PATTERN ) != 0 ) {
            if (fPattern.size()==0 && nvalue.length()>0) {
                        throw new InvalidDatatypeValueException("cvc-pattern-valid", //Audit Issue: User marked 'cvc-pattern-valid' string as Not an Issue string with comment: ''.
                                new Object[]{content,
                                "(empty string)",
                                fTypeName});
            }
        ...
        if (fVariety == VARIETY_ATOMIC) {
            ...
            if (fPatternType != SPECIAL_PATTERN_NONE) {
                ...
                if (seenErr) {
                    throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.1", //Audit Issue: User marked 'cvc-datatype-valid.1.2.1' string as Not an Issue string with comment: ''.
            ...
            throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3", //Audit Issue: User marked 'cvc-datatype-valid.1.2.3' string as Not an Issue string with comment: ''.
    ...
    public String getLexicalFacetValue(short facetName) {
        switch (facetName) {
            ...
            case FACET_FRACTIONDIGITS:
                if (fValidationDV == DV_INTEGER) {
                    return "0"; //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
                }
            ...
            if (fValidationDV == DV_INTEGER) {
                facets[count] =
                    new XSFacetImpl(
                            ...
                            "0", //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
                            true,
