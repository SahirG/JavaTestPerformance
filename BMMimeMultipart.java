...
public  class BMMimeMultipart extends MimeMultipart {
    ...
    public InputStream initStream() throws MessagingException {
        ...
        if (in == null) {
            try {
                ...
                throw new MessagingException("No inputstream from datasource"); //Audit Issue: User marked 'No inputstream from datasource' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No inputstream from datasource' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No inputstream from datasource' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No inputstream from datasource' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No inputstream from datasource' string as Not an Issue string with comment: ''.
            }

            if (!in.markSupported()) {
                throw new MessagingException(
                    "InputStream does not support Marking"); //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''.
            }
        }
        return in;
    }
    ...
    public MimeBodyPart getNextPart(
        ...
        if (!stream.markSupported()) {
            throw new Exception("InputStream does not support Marking"); //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'InputStream does not support Marking' string as Not an Issue string with comment: ''.
        }
        ...
        if (lastBodyPartFound()) {
            throw new Exception("No parts found in Multipart InputStream"); //Audit Issue: User marked 'No parts found in Multipart InputStream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No parts found in Multipart InputStream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No parts found in Multipart InputStream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No parts found in Multipart InputStream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No parts found in Multipart InputStream' string as Not an Issue string with comment: ''.
        }
        ...
        if (sin != null) {
            ...
            if (b == -1) {
                throw new Exception(
                    "End of Stream encountered while reading part headers"); //Audit Issue: User marked 'End of Stream encountered while reading part headers' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of Stream encountered while reading part headers' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of Stream encountered while reading part headers' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of Stream encountered while reading part headers' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of Stream encountered while reading part headers' string as Not an Issue string with comment: ''.
            }
            long[] v = new long[1];
    ...
    private int readHeaders(InputStream is) throws Exception {
        ...
        if (b == -1) {
            throw new Exception(
            "End of inputstream while reading Mime-Part Headers"); //Audit Issue: User marked 'End of inputstream while reading Mime-Part Headers' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of inputstream while reading Mime-Part Headers' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of inputstream while reading Mime-Part Headers' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of inputstream while reading Mime-Part Headers' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of inputstream while reading Mime-Part Headers' string as Not an Issue string with comment: ''.
        }
        return b;
    }
    ...
    private boolean skipLWSPAndCRLF(InputStream is) throws Exception {
        ...
        if (b == -1) {
            ...
            if (!lastPartFound.get(0)) {
                throw new Exception(
                        "End of Multipart Stream before encountering  closing boundary delimiter"); //Audit Issue: User marked 'End of Multipart Stream before encountering  closing boundary delimiter' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of Multipart Stream before encountering  closing boundary delimiter' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of Multipart Stream before encountering  closing boundary delimiter' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of Multipart Stream before encountering  closing boundary delimiter' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'End of Multipart Stream before encountering  closing boundary delimiter' string as Not an Issue string with comment: ''.
            }
            return true;
        }
        return false;
