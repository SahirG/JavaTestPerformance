...
public class AnyImpl extends Any
{
    ...
    public void insert_Object(org.omg.CORBA.Object o, TypeCode tc)
    {
        ...
        try {
            if ( tc.id().equals("IDL:omg.org/CORBA/Object:1.0") || o._is_a(tc.id()) ) //Audit Issue: User marked 'IDL:omg.org/CORBA/Object:1.0' string as Not an Issue string with comment: ''.
                {
                    typeCode = TypeCodeImpl.convertToNative(orb, tc);
                    object = o;
                }
    ...
    public org.omg.CORBA.Object extract_Object()
    {
        ...
        try {
            ...
            if (typeCode.id().equals("IDL:omg.org/CORBA/Object:1.0") || obj._is_a(typeCode.id())) { //Audit Issue: User marked 'IDL:omg.org/CORBA/Object:1.0' string as Not an Issue string with comment: ''.
                return obj;
            } else {
