...
public class XMLEntityScanner implements XMLLocator  {
        ...
        if (fCurrentEntity.stream != null) {
            ...
            if (fCurrentEntity.encoding == null ||
                ...
                if(fCurrentEntity.encoding != null && fCurrentEntity.encoding.startsWith("UTF-16")) {
                    ...
                    if(ENCODING.equals("ISO-10646-UCS-4")) { //Audit Issue: User marked 'ISO-10646-UCS-4' string as Not an Issue string with comment: ''.
                    ...
                    if(ENCODING.equals("ISO-10646-UCS-2")) { //Audit Issue: User marked 'ISO-10646-UCS-2' string as Not an Issue string with comment: ''.
                        if(fCurrentEntity.encoding.equals("UTF-16BE")) {
                ...
                // the encoding
                if (DEBUG_ENCODINGS) {
                    System.out.println("$$$ creating new reader from stream: "+ //Audit Issue: User marked '$$$ creating new reader from stream: ' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ creating new reader from stream: ' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ creating new reader from stream: ' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ creating new reader from stream: ' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ creating new reader from stream: ' string as Not an Issue string with comment: ''.
                ...
                if (DEBUG_ENCODINGS)
                    System.out.println("$$$ reusing old reader on stream"); //Audit Issue: User marked '$$$ reusing old reader on stream' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ reusing old reader on stream' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ reusing old reader on stream' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ reusing old reader on stream' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ reusing old reader on stream' string as Not an Issue string with comment: ''.
            }
        }
    ...
    throws IOException {
        ...
        if (ENCODING.equals("US-ASCII")) { //Audit Issue: User marked 'US-ASCII' string as Not an Issue string with comment: ''.
            if (DEBUG_ENCODINGS) {
                System.out.println("$$$ creating ASCIIReader"); //Audit Issue: User marked '$$$ creating ASCIIReader' string as Not an Issue string with comment: ''.
            }
        ...
        if (!validIANA || (fAllowJavaEncodings && !validJava)) {
            fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN,
                    "EncodingDeclInvalid", //Audit Issue: User marked 'EncodingDeclInvalid' string as Not an Issue string with comment: ''.
                    new Object[] { encoding },
                    XMLErrorReporter.SEVERITY_FATAL_ERROR);
        ...
        else if (javaEncoding.equals("ASCII")) { //Audit Issue: User marked 'ASCII' string as Not an Issue string with comment: ''.
            if (DEBUG_ENCODINGS) {
                System.out.println("$$$ creating ASCIIReader"); //Audit Issue: User marked '$$$ creating ASCIIReader' string as Not an Issue string with comment: ''.
            }
        ...
        if (DEBUG_ENCODINGS) {
            System.out.print("$$$ creating Java InputStreamReader: encoding="+javaEncoding); //Audit Issue: User marked '$$$ creating Java InputStreamReader: encoding=' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ creating Java InputStreamReader: encoding=' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ creating Java InputStreamReader: encoding=' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ creating Java InputStreamReader: encoding=' string as Not an Issue string with comment: ''. //Audit Issue: User marked '$$$ creating Java InputStreamReader: encoding=' string as Not an Issue string with comment: ''.
    ...
    protected Object[] getEncodingName(byte[] b4, int count) {
        ...
        if (b0 == 0x00 && b1 == 0x00 && b2 == 0x00 && b3 == 0x3C) {
            ...
            return new Object [] {"ISO-10646-UCS-4", new Boolean(true)}; //Audit Issue: User marked 'ISO-10646-UCS-4' string as Not an Issue string with comment: ''.
        }
        if (b0 == 0x3C && b1 == 0x00 && b2 == 0x00 && b3 == 0x00) {
            // UCS-4, little endian (4321)
            return new Object [] {"ISO-10646-UCS-4", new Boolean(false)}; //Audit Issue: User marked 'ISO-10646-UCS-4' string as Not an Issue string with comment: ''.
        }
        if (b0 == 0x00 && b1 == 0x00 && b2 == 0x3C && b3 == 0x00) {
            // UCS-4, unusual octet order (2143)
            // REVISIT: What should this be?
            return new Object [] {"ISO-10646-UCS-4", null}; //Audit Issue: User marked 'ISO-10646-UCS-4' string as Not an Issue string with comment: ''.
        }
        ...
        if (b0 == 0x4C && b1 == 0x6F && b2 == 0xA7 && b3 == 0x94) {
            ...
            return new Object [] {"CP037", null}; //Audit Issue: User marked 'CP037' string as Not an Issue string with comment: ''.
        }
