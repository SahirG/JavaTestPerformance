...
public class JPEGMetadata extends IIOMetadata implements Cloneable {
    ...
    JPEGMetadata(boolean isStream,
        ...
        while (!done) {
            ...
            case JPEG.SOF2:
                if (isStream) {
                    throw new IIOException
                        ("SOF not permitted in stream metadata"); //Audit Issue: User marked 'SOF not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'SOF not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'SOF not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'SOF not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'SOF not permitted in stream metadata' string as Not an Issue string with comment: ''.
                }
            ...
            case JPEG.APP0:
                ...
                if ((buf[ptr+3] == 'J')
                    ...
                    if (inThumb) {
                        ...
                        throw new IIOException
                            ("JFIF not permitted in stream metadata"); //Audit Issue: User marked 'JFIF not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'JFIF not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'JFIF not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'JFIF not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'JFIF not permitted in stream metadata' string as Not an Issue string with comment: ''.
                    } else if (markerSequence.isEmpty() == false) {
                        throw new IIOException
                            ("JFIF APP0 must be first marker after SOI"); //Audit Issue: User marked 'JFIF APP0 must be first marker after SOI' string as Not an Issue string with comment: ''.
                    } else {
                    ...
                    if (isStream) {
                        throw new IIOException
                            ("JFXX not permitted in stream metadata"); //Audit Issue: User marked 'JFXX not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'JFXX not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'JFXX not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'JFXX not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'JFXX not permitted in stream metadata' string as Not an Issue string with comment: ''.
                    }
                    if (inThumb) {
                        throw new IIOException
            ...
            case JPEG.APP2:
                ...
                if ((buffer.buf[buffer.bufPtr+3] == 'I')
                    ...
                    if (isStream) {
                        throw new IIOException
                            ("ICC profiles not permitted in stream metadata"); //Audit Issue: User marked 'ICC profiles not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'ICC profiles not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'ICC profiles not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'ICC profiles not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'ICC profiles not permitted in stream metadata' string as Not an Issue string with comment: ''.
                    }
            ...
            case JPEG.APP14:
                ...
                if ((buffer.buf[buffer.bufPtr+3] == 'A')
                    ...
                    if (isStream) {
                        throw new IIOException
                      ("Adobe APP14 markers not permitted in stream metadata"); //Audit Issue: User marked 'Adobe APP14 markers not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Adobe APP14 markers not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Adobe APP14 markers not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Adobe APP14 markers not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Adobe APP14 markers not permitted in stream metadata' string as Not an Issue string with comment: ''.
                    }
            ...
            case JPEG.SOS:
                if (isStream) {
                    throw new IIOException
                        ("SOS not permitted in stream metadata"); //Audit Issue: User marked 'SOS not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'SOS not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'SOS not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'SOS not permitted in stream metadata' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'SOS not permitted in stream metadata' string as Not an Issue string with comment: ''.
                }
        ...
        if (!isConsistent()) {
            throw new IIOException("Inconsistent metadata read from stream"); //Audit Issue: User marked 'Inconsistent metadata read from stream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Inconsistent metadata read from stream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Inconsistent metadata read from stream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Inconsistent metadata read from stream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Inconsistent metadata read from stream' string as Not an Issue string with comment: ''.
        }
    }
    ...
    JPEGMetadata(ImageWriteParam param, JPEGImageWriter writer) {
        ...
        if (!isConsistent()) {
            throw new InternalError("Default stream metadata is inconsistent"); //Audit Issue: User marked 'Default stream metadata is inconsistent' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Default stream metadata is inconsistent' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Default stream metadata is inconsistent' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Default stream metadata is inconsistent' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Default stream metadata is inconsistent' string as Not an Issue string with comment: ''.
        }
    }
    ...
    public void mergeTree(String formatName, Node root)
        ...
        if (!isConsistent()) {
            ...
            throw new IIOInvalidTreeException
                ("Merged tree is invalid; original restored", root); //Audit Issue: User marked 'Merged tree is invalid; original restored' string as Not an Issue string with comment: ''.
        }
    }
    ...
    private void mergeNativeTree(Node root) throws IIOInvalidTreeException {
        ...
        if (name != ((isStream) ? JPEG.nativeStreamMetadataFormatName
            ...
            throw new IIOInvalidTreeException("Invalid root node name: " + name, //Audit Issue: User marked 'Invalid root node name: ' string as Not an Issue string with comment: ''.
                                              root);
        }
    ...
    private void mergeSequenceSubtree(Node sequenceTree)
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if (name.equals("dqt")) {
                ...
                throw new IIOInvalidTreeException("Invalid node: " + name, node); //Audit Issue: User marked 'Invalid node: ' string as Not an Issue string with comment: ''.
            }
        }
    }
        ...
        if (!oldDQTs.isEmpty()) {
            ...
            for (int i = 0; i < children.getLength(); i++) {
                ...
                int childID = MarkerSegment.getAttributeValue(child,
                                                              null,
                                                              "qtableId", //Audit Issue: User marked 'qtableId' string as Not an Issue string with comment: ''.
                                                              0, 3,
                                                              true);
    ...
    private void mergeDHTNode(Node node) throws IIOInvalidTreeException {
        ...
        if (!oldDHTs.isEmpty()) {
            ...
            for (int i = 0; i < children.getLength(); i++) {
                ...
                int childID = MarkerSegment.getAttributeValue(child,
                                                              attrs,
                                                              "htableId", //Audit Issue: User marked 'htableId' string as Not an Issue string with comment: ''.
                                                              0, 3,
                                                              true);
    ...
    void setFromMarkerSequenceNode(Node markerSequenceNode)
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if (childName.equals("dqt")) {
                ...
                throw new IIOInvalidTreeException("Invalid " //Audit Issue: User marked 'Invalid ' string as Not an Issue string with comment: ''.
                    + (isStream ? "stream " : "image ") + "child: " //Audit Issue: User marked 'stream ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'stream ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'stream ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'stream ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'stream ' string as Not an Issue string with comment: ''.
                    + childName, node);
            }
        }
    }
