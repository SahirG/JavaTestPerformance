...
public final class TypeCodeImpl extends TypeCode
{
    ...
    static final String[] kindNames = {
        "null",
        "void", //Audit Issue: User marked 'void' string as Not an Issue string with comment: ''.
        "short",
        "long",
        "ushort",
        "ulong",
        ...
        case TCKind._tk_objref:
            {
                ...
                setId("IDL:omg.org/CORBA/Object:1.0"); //Audit Issue: User marked 'IDL:omg.org/CORBA/Object:1.0' string as Not an Issue string with comment: ''.
                _name = "Object";
                break;
            }
    ...
    */
    ...
    public String description() {
        return "TypeCodeImpl with kind " + _kind + " and id " + _id; //Audit Issue: User marked ' and id ' string as Not an Issue string with comment: ''.
    }
