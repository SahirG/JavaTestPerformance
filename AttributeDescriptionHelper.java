...
{
    private static String  _id = "IDL:omg.org/CORBA/AttributeDescription:1.0"; //Audit Issue: User marked 'IDL:omg.org/CORBA/AttributeDescription:1.0' string as Not an Issue string with comment: ''.
                        ...
                        if (__typeCode == null)
                            {
                                ...
                                _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (com.sun.org.omg.CORBA.IdentifierHelper.id (), "Identifier", _tcOf_members0); //Audit Issue: User marked 'Identifier' string as Not an Issue string with comment: ''.
                                _members0[0] = new org.omg.CORBA.StructMember (
                                                                               "name",
                                                                               _tcOf_members0,
                                                                               null);
                                _tcOf_members0 = org.omg.CORBA.ORB.init ().create_string_tc (0);
                                _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (com.sun.org.omg.CORBA.RepositoryIdHelper.id (), "RepositoryId", _tcOf_members0); //Audit Issue: User marked 'RepositoryId' string as Not an Issue string with comment: ''.
                                _members0[1] = new org.omg.CORBA.StructMember (
                                                                               "id", //Audit Issue: User marked 'id' string as Not an Issue string with comment: ''.
                                                                               _tcOf_members0,
                                                                               null);
                                _tcOf_members0 = org.omg.CORBA.ORB.init ().create_string_tc (0);
                                _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (com.sun.org.omg.CORBA.RepositoryIdHelper.id (), "RepositoryId", _tcOf_members0); //Audit Issue: User marked 'RepositoryId' string as Not an Issue string with comment: ''.
