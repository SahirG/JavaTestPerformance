...
public class _ServerManagerStub extends org.omg.CORBA.portable.ObjectImpl implements com.sun.corba.se.spi.activation.ServerManager
{
  ...
  public com.sun.corba.se.spi.activation.LocatorPackage.ServerLocation locateServer (int serverId, String endPoint) throws com.sun.corba.se.spi.activation.NoSuchEndPoint, com.sun.corba.se.spi.activation.ServerNotRegistered, com.sun.corba.se.spi.activation.ServerHeldDown
  {
            ...
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:activation/NoSuchEndPoint:1.0")) //Audit Issue: User marked 'IDL:activation/NoSuchEndPoint:1.0' string as Not an Issue string with comment: ''.
                    throw com.sun.corba.se.spi.activation.NoSuchEndPointHelper.read ($in);
                else if (_id.equals ("IDL:activation/ServerNotRegistered:1.0")) //Audit Issue: User marked 'IDL:activation/ServerNotRegistered:1.0' string as Not an Issue string with comment: ''.
                    throw com.sun.corba.se.spi.activation.ServerNotRegisteredHelper.read ($in);
                else if (_id.equals ("IDL:activation/ServerHeldDown:1.0")) //Audit Issue: User marked 'IDL:activation/ServerHeldDown:1.0' string as Not an Issue string with comment: ''.
  ...
  public com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORB locateServerForORB (int serverId, String orbId) throws com.sun.corba.se.spi.activation.InvalidORBid, com.sun.corba.se.spi.activation.ServerNotRegistered, com.sun.corba.se.spi.activation.ServerHeldDown
  {
            ...
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:activation/InvalidORBid:1.0")) //Audit Issue: User marked 'IDL:activation/InvalidORBid:1.0' string as Not an Issue string with comment: ''.
  ...
  private static String[] __ids = {
    "IDL:activation/ServerManager:1.0",  //Audit Issue: User marked 'IDL:activation/ServerManager:1.0' string as Not an Issue string with comment: ''.
    "IDL:activation/Activator:1.0",  //Audit Issue: User marked 'IDL:activation/Activator:1.0' string as Not an Issue string with comment: ''.
    "IDL:activation/Locator:1.0"}; //Audit Issue: User marked 'IDL:activation/Locator:1.0' string as Not an Issue string with comment: ''.
