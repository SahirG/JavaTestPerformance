    ...
    public int read() throws IOException {
        ...
        if (b0 >= 0x80) {
            throw new MalformedByteSequenceException(fFormatter,
                ...
                "InvalidASCII", new Object [] {Integer.toString(b0)}); //Audit Issue: User marked 'InvalidASCII' string as Not an Issue string with comment: ''.
        }
        return b0;
    } // read():int
    ...
    public int read(char ch[], int offset, int length) throws IOException {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (b0 < 0) {
                throw new MalformedByteSequenceException(fFormatter,
                    fLocale, XMLMessageFormatter.XML_DOMAIN,
                    "InvalidASCII", new Object [] {Integer.toString(b0 & 0x0FF)}); //Audit Issue: User marked 'InvalidASCII' string as Not an Issue string with comment: ''.
            }
            ch[offset + i] = (char)b0;
        }
        return count;
