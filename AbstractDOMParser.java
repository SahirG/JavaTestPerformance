...
public class AbstractDOMParser extends AbstractXMLDocumentParser {
    ...
    "com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl"; //Audit Issue: User marked 'com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl' string as Not an Issue string with comment: ''.

    protected static final String PSVI_DOCUMENT_CLASS_NAME =
    "com.sun.org.apache.xerces.internal.dom.PSVIDocumentImpl"; //Audit Issue: User marked 'com.sun.org.apache.xerces.internal.dom.PSVIDocumentImpl' string as Not an Issue string with comment: ''.
            ...
            try {
                ...
                if (!Document.class.isAssignableFrom (_class)) {
                    throw new IllegalArgumentException (
                        ...
                        "InvalidDocumentClassName", new Object [] {documentClassName})); //Audit Issue: User marked 'InvalidDocumentClassName' string as Not an Issue string with comment: ''.
                }
            }
                ...
                throw new IllegalArgumentException (
                    DOMMessageFormatter.formatMessage(
                    DOMMessageFormatter.DOM_DOMAIN,
                    "MissingDocumentClassName", new Object [] {documentClassName})); //Audit Issue: User marked 'MissingDocumentClassName' string as Not an Issue string with comment: ''.
            }
        }
    ...
    throws XNIException {
        if (DEBUG_EVENTS) {
            System.out.println ("==>startGeneralEntity ("+name+")"); //Audit Issue: User marked '==>startGeneralEntity (' string as Not an Issue string with comment: ''.
            if (DEBUG_BASEURI) {
                System.out.println ("   expandedSystemId( **baseURI): "+identifier.getExpandedSystemId ()); //Audit Issue: User marked '   expandedSystemId( **baseURI): ' string as Not an Issue string with comment: ''.
                System.out.println ("   baseURI:"+ identifier.getBaseSystemId ()); //Audit Issue: User marked '   baseURI:' string as Not an Issue string with comment: ''.
            }
        }
    ...
    throws XNIException {
        ...
        if (DEBUG_EVENTS) {
            System.out.println ("==>processingInstruction ("+target+")"); //Audit Issue: User marked '==>processingInstruction (' string as Not an Issue string with comment: ''.
        }
        if (!fDeferNodeExpansion) {
            if (fFilterReject) {
                return;
            ...
            if (fDocumentClassName.equals (DEFAULT_DOCUMENT_CLASS_NAME)) {
                ...
                try {
                    ...
                    throw new RuntimeException (
                        DOMMessageFormatter.formatMessage(
                        DOMMessageFormatter.DOM_DOMAIN,
                        "CannotCreateDocumentClass", //Audit Issue: User marked 'CannotCreateDocumentClass' string as Not an Issue string with comment: ''.
    ...
    throws XNIException {
        if (!fDeferNodeExpansion) {
            ...
            if (fDocumentImpl != null) {
                ...
                fDocumentImpl.setXmlStandalone ("yes".equals (standalone)); //Audit Issue: User marked 'yes' string as Not an Issue string with comment: ''.
            }
        }
        else {
            if (version != null)
            ...
            fDeferredDocumentImpl.setXmlStandalone ("yes".equals (standalone)); //Audit Issue: User marked 'yes' string as Not an Issue string with comment: ''.
        }
    ...
    throws XNIException {
        if (DEBUG_EVENTS) {
            System.out.println ("==>startElement ("+element.rawname+")"); //Audit Issue: User marked '==>startElement (' string as Not an Issue string with comment: ''.
        }
        if (!fDeferNodeExpansion) {
            if (fFilterReject) {
                ...
                if (fDocumentImpl != null) {
                    ...
                    if (attrPSVI != null && fNamespaceAware) {
                        ...
                        if (isDeclared) {
                            ...
                            id = "ID".equals (type); //Audit Issue: User marked 'ID' string as Not an Issue string with comment: ''.
                        }
                        attrImpl.setType (type);
                    }
    ...
    public void characters (XMLString text, Augmentations augs) throws XNIException {
        ...
        if (DEBUG_EVENTS) {
            System.out.println ("==>characters(): "+text.toString ()); //Audit Issue: User marked '==>characters(): ' string as Not an Issue string with comment: ''.
        }
    ...
    public void endElement (QName element, Augmentations augs) throws XNIException {
        if (DEBUG_EVENTS) {
            System.out.println ("==>endElement ("+element.rawname+")"); //Audit Issue: User marked '==>endElement (' string as Not an Issue string with comment: ''.
        }
        if (!fDeferNodeExpansion) {
    ...
    public void endGeneralEntity (String name, Augmentations augs) throws XNIException {
        if (DEBUG_EVENTS) {
            System.out.println ("==>endGeneralEntity: ("+name+")"); //Audit Issue: User marked '==>endGeneralEntity: (' string as Not an Issue string with comment: ''.
        }
        if (!fDeferNodeExpansion) {
    ...
    protected final void handleBaseURI (Node node){
        if (fDocumentImpl != null) {
            ...
            if (nodeType == Node.ELEMENT_NODE) {
                ...
                } else if (((Element)node).getAttributeNode ("xml:base") != null) { //Audit Issue: User marked 'xml:base' string as Not an Issue string with comment: ''.
                    return;
                }
                ...
                if (baseURI !=null && !baseURI.equals (fDocumentImpl.getDocumentURI ())) {
                    if (fNamespaceAware) {
                        ((Element)node).setAttributeNS ("http://www.w3.org/XML/1998/namespace", "xml:base", baseURI); //Audit Issue: User marked 'xml:base' string as Not an Issue string with comment: ''.
                    } else {
                        ((Element)node).setAttribute ("xml:base", baseURI); //Audit Issue: User marked 'xml:base' string as Not an Issue string with comment: ''.
                    }
                }
            }
                ...
                if (baseURI !=null && fErrorHandler != null) {
                    ...
                    error.fType = "pi-base-uri-not-preserved"; //Audit Issue: User marked 'pi-base-uri-not-preserved' string as Not an Issue string with comment: ''.
    ...
    protected final void handleBaseURI (int node){
        ...
        if (nodeType == Node.ELEMENT_NODE) {
            ...
            if (baseURI !=null && !baseURI.equals (fDeferredDocumentImpl.getDocumentURI ())) {
                ...
                "xml:base", //Audit Issue: User marked 'xml:base' string as Not an Issue string with comment: ''.
    ...
    public void startDTD (XMLLocator locator, Augmentations augs) throws XNIException {
        if (DEBUG_EVENTS) {
            System.out.println ("==>startDTD"); //Audit Issue: User marked '==>startDTD' string as Not an Issue string with comment: ''.
            if (DEBUG_BASEURI) {
                System.out.println ("   expandedSystemId: "+locator.getExpandedSystemId ()); //Audit Issue: User marked '   expandedSystemId: ' string as Not an Issue string with comment: ''.
                System.out.println ("   baseURI:"+ locator.getBaseSystemId ()); //Audit Issue: User marked '   baseURI:' string as Not an Issue string with comment: ''.
            }
        }
    ...
    public void endDTD (Augmentations augs) throws XNIException {
        if (DEBUG_EVENTS) {
            System.out.println ("==>endDTD()"); //Audit Issue: User marked '==>endDTD()' string as Not an Issue string with comment: ''.
        }
        fInDTD = false;
    ...
    Augmentations augs) throws XNIException {
        if (DEBUG_EVENTS) {
            System.out.println ("==>startExternalSubset"); //Audit Issue: User marked '==>startExternalSubset' string as Not an Issue string with comment: ''.
            if (DEBUG_BASEURI) {
                System.out.println ("   expandedSystemId: "+identifier.getExpandedSystemId ()); //Audit Issue: User marked '   expandedSystemId: ' string as Not an Issue string with comment: ''.
                System.out.println ("   baseURI:"+ identifier.getBaseSystemId ()); //Audit Issue: User marked '   baseURI:' string as Not an Issue string with comment: ''.
            }
        }
    ...
    Augmentations augs) throws XNIException {
        ...
        if (DEBUG_EVENTS) {
            System.out.println ("==>internalEntityDecl: "+name); //Audit Issue: User marked '==>internalEntityDecl: ' string as Not an Issue string with comment: ''.
            if (DEBUG_BASEURI) {
                System.out.println ("   baseURI:"+ (String)fBaseURIStack.peek ()); //Audit Issue: User marked '   baseURI:' string as Not an Issue string with comment: ''.
            }
        }
        // internal subset string
        if (fInternalSubset != null && !fInDTDExternalSubset) {
            fInternalSubset.append ("<!ENTITY "); //Audit Issue: User marked '<!ENTITY ' string as Not an Issue string with comment: ''.
            if (name.startsWith ("%")) {
                fInternalSubset.append ("% ");
    ...
    Augmentations augs) throws XNIException {
        ...
        if (DEBUG_EVENTS) {
            System.out.println ("==>externalEntityDecl: "+name); //Audit Issue: User marked '==>externalEntityDecl: ' string as Not an Issue string with comment: ''.
            if (DEBUG_BASEURI) {
                System.out.println ("   expandedSystemId:"+ identifier.getExpandedSystemId ()); //Audit Issue: User marked '   expandedSystemId:' string as Not an Issue string with comment: ''.
                System.out.println ("   baseURI:"+ identifier.getBaseSystemId ()); //Audit Issue: User marked '   baseURI:' string as Not an Issue string with comment: ''.
            }
        ...
        if (fInternalSubset != null && !fInDTDExternalSubset) {
            ...
            fInternalSubset.append (' ');
            if (publicId != null) {
                fInternalSubset.append ("PUBLIC '"); //Audit Issue: User marked 'PUBLIC '' string as Not an Issue string with comment: ''.
                fInternalSubset.append (publicId);
                fInternalSubset.append ("' '");
            }
            else {
                fInternalSubset.append ("SYSTEM '"); //Audit Issue: User marked 'SYSTEM '' string as Not an Issue string with comment: ''.
            }
    ...
    Augmentations augs) throws XNIException {
        if (DEBUG_EVENTS) {
            System.out.println ("==>startParameterEntity: "+name); //Audit Issue: User marked '==>startParameterEntity: ' string as Not an Issue string with comment: ''.
            if (DEBUG_BASEURI) {
                System.out.println ("   expandedSystemId: "+identifier.getExpandedSystemId ()); //Audit Issue: User marked '   expandedSystemId: ' string as Not an Issue string with comment: ''.
                System.out.println ("   baseURI:"+ identifier.getBaseSystemId ()); //Audit Issue: User marked '   baseURI:' string as Not an Issue string with comment: ''.
            }
    ...
    XMLString nonNormalizedDefaultValue, Augmentations augs) throws XNIException {
        ...
        if (fDeferredDocumentImpl != null) {
            ...
            if (defaultValue != null) {
                ...
                if ("ID".equals (type)) { //Audit Issue: User marked 'ID' string as Not an Issue string with comment: ''.
        ...
        // full expansion
            ...
            if (defaultValue != null) {
                ...
                attr.setIdAttribute ("ID".equals (type)); //Audit Issue: User marked 'ID' string as Not an Issue string with comment: ''.
