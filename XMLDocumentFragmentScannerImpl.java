            ...
            if (!fEntityScanner.scanData("]]>", contentBuffer)) {
                ...
                if (c != -1 && isInvalidLiteral(c)) {
                    if (XMLChar.isHighSurrogate(c)) {
                        ...
                        reportFatalError("InvalidCharInCDSect", //Audit Issue: User marked 'InvalidCharInCDSect' string as Not an Issue string with comment: ''.
    ...
    protected class FragmentContentDriver
        ...
        private void startOfMarkup() throws IOException {
            ...
            switch(ch){
                ...
                case '!' :{
                    ...
                    if (fEntityScanner.skipChar('-')) {
                        if (!fEntityScanner.skipChar('-')) {
                            reportFatalError("InvalidCommentStart", //Audit Issue: User marked 'InvalidCommentStart' string as Not an Issue string with comment: ''.
                                    null);
                        }
        ...
        public int next() throws IOException, XNIException {
            ...
            try {
                ...
                if(DEBUG_NEXT){
                    System.out.println("Actual scanner state set by decideSubState is = " + getScannerStateName(fScannerState)); //Audit Issue: User marked 'Actual scanner state set by decideSubState is = ' string as Not an Issue string with comment: ''.
                }
                        ...
                        do{
                            ...
                            if (c == '<') {
                                ...
                                if (XMLChar.isHighSurrogate(c)) {
                                    ...
                                    reportFatalError("InvalidCharInContent", //Audit Issue: User marked 'InvalidCharInContent' string as Not an Issue string with comment: ''.
                                            new Object[] {
