...
public class WindowsLookAndFeel extends BasicLookAndFeel
{
 ...
 "RadioButtonMenuItemUI", windowsPackageName + "WindowsRadioButtonMenuItemUI",
        "ToggleButtonUI", windowsPackageName + "WindowsToggleButtonUI",
         "ProgressBarUI", windowsPackageName + "WindowsProgressBarUI", //Audit Issue: User marked 'WindowsProgressBarUI' string as Not an Issue string with comment: ''.
              "SliderUI", windowsPackageName + "WindowsSliderUI", //Audit Issue: User marked 'WindowsSliderUI' string as Not an Issue string with comment: ''.
  ...
  "inactiveCaptionBorder", "#C0C0C0", /* Border color for inactive caption (title bar) window borders. */
      ...
      "textHighlightText", "#FFFFFF", /* Text color when selected */
       ...
       "controlHighlight", "#C0C0C0", //Audit Issue: User marked '#C0C0C0' string as Not an Issue string with comment: ''.
   ...
   /**
    ...
    protected void initComponentDefaults(UIDefaults table)
    {
        ...
        Object WindowBorderWidth      = new DesktopProperty(
                                                       "win.frame.sizingBorderWidth", //Audit Issue: User marked 'win.frame.sizingBorderWidth' string as Not an Issue string with comment: ''.
                                                       Integer.valueOf(1));
        Object TitlePaneHeight        = new DesktopProperty(
                                                       "win.frame.captionHeight",
                                                       Integer.valueOf(18));
        Object TitleButtonWidth       = new DesktopProperty(
                                                       "win.frame.captionButtonWidth", //Audit Issue: User marked 'win.frame.captionButtonWidth' string as Not an Issue string with comment: ''.
                                                       Integer.valueOf(16));
        ...
        Object scrollBarWidth = new DesktopProperty("win.scrollbar.width", Integer.valueOf(16)); //Audit Issue: User marked 'win.scrollbar.width' string as Not an Issue string with comment: ''.
        ...
        Object[] defaults = {
            ...
            "Button.dashedRectGapWidth", new XPValue(Integer.valueOf(6), Integer.valueOf(10)), //Audit Issue: User marked 'Button.dashedRectGapWidth' string as Not an Issue string with comment: ''.
            ...
            "Caret.width", //Audit Issue: User marked 'Caret.width' string as Not an Issue string with comment: ''.
                  new DesktopProperty("win.caret.width", null), //Audit Issue: User marked 'win.caret.width' string as Not an Issue string with comment: ''.
            ...
            "ComboBox.ancestorInputMap", new UIDefaults.LazyInputMap(new Object[] {
                   "ESCAPE", "hidePopup", //Audit Issue: User marked 'hidePopup' string as Not an Issue string with comment: ''.
            ...
            // DesktopIcon
            "DesktopIcon.width", Integer.valueOf(160), //Audit Issue: User marked 'DesktopIcon.width' string as Not an Issue string with comment: ''.
            ...
            "FileChooser.newFolderIcon",   new LazyWindowsIcon("fileChooserIcon NewFolder",
                                                               "icons/NewFolder.gif"),
            "FileChooser.useSystemExtensionHiding", Boolean.TRUE, //Audit Issue: User marked 'FileChooser.useSystemExtensionHiding' string as Not an Issue string with comment: ''.
            ...
            "InternalFrame.titleButtonWidth",  TitleButtonWidth, //Audit Issue: User marked 'InternalFrame.titleButtonWidth' string as Not an Issue string with comment: ''.
            ...
            "InternalFrame.borderWidth", WindowBorderWidth, //Audit Issue: User marked 'InternalFrame.borderWidth' string as Not an Issue string with comment: ''.
        ...
        "com.sun.java.swing.plaf.windows.WindowsInternalFrameTitlePane$ScalableIconUIResource",
            ...
            "InternalFrame.windowBindings", new Object[] {
                "shift ESCAPE", "showSystemMenu",
                  "ctrl SPACE", "showSystemMenu",
                      "ESCAPE", "hideSystemMenu"}, //Audit Issue: User marked 'hideSystemMenu' string as Not an Issue string with comment: ''.
            ...
            "OptionPane.buttonMinimumWidth", new XPDLUValue(50, 50, SwingConstants.EAST), //Audit Issue: User marked 'OptionPane.buttonMinimumWidth' string as Not an Issue string with comment: ''.
            ...
            // *** ProgressBar
            "ProgressBar.font", ControlFont, //Audit Issue: User marked 'ProgressBar.font' string as Not an Issue string with comment: ''.
            "ProgressBar.foreground",  SelectionBackgroundColor, //Audit Issue: User marked 'ProgressBar.foreground' string as Not an Issue string with comment: ''.
            "ProgressBar.background", ControlBackgroundColor, //Audit Issue: User marked 'ProgressBar.background' string as Not an Issue string with comment: ''.
            "ProgressBar.shadow", ControlShadowColor, //Audit Issue: User marked 'ProgressBar.shadow' string as Not an Issue string with comment: ''.
            "ProgressBar.highlight", ControlHighlightColor, //Audit Issue: User marked 'ProgressBar.highlight' string as Not an Issue string with comment: ''.
            "ProgressBar.selectionForeground", ControlBackgroundColor, //Audit Issue: User marked 'ProgressBar.selectionForeground' string as Not an Issue string with comment: ''.
            "ProgressBar.selectionBackground", SelectionBackgroundColor, //Audit Issue: User marked 'ProgressBar.selectionBackground' string as Not an Issue string with comment: ''.
            "ProgressBar.cellLength", Integer.valueOf(7), //Audit Issue: User marked 'ProgressBar.cellLength' string as Not an Issue string with comment: ''.
            "ProgressBar.cellSpacing", Integer.valueOf(2), //Audit Issue: User marked 'ProgressBar.cellSpacing' string as Not an Issue string with comment: ''.
            "ProgressBar.indeterminateInsets", new Insets(3, 3, 3, 3), //Audit Issue: User marked 'ProgressBar.indeterminateInsets' string as Not an Issue string with comment: ''.
            ...
            "ScrollBar.width", scrollBarWidth, //Audit Issue: User marked 'ScrollBar.width' string as Not an Issue string with comment: ''.
            ...
            // *** Slider.
            "Slider.font", ControlFont, //Audit Issue: User marked 'Slider.font' string as Not an Issue string with comment: ''.
            "Slider.foreground", ControlBackgroundColor, //Audit Issue: User marked 'Slider.foreground' string as Not an Issue string with comment: ''.
            "Slider.background", ControlBackgroundColor, //Audit Issue: User marked 'Slider.background' string as Not an Issue string with comment: ''.
            "Slider.highlight", ControlHighlightColor, //Audit Issue: User marked 'Slider.highlight' string as Not an Issue string with comment: ''.
            "Slider.shadow", ControlShadowColor, //Audit Issue: User marked 'Slider.shadow' string as Not an Issue string with comment: ''.
            "Slider.focus", ControlDarkShadowColor, //Audit Issue: User marked 'Slider.focus' string as Not an Issue string with comment: ''.
            "Slider.focusInputMap", //Audit Issue: User marked 'Slider.focusInputMap' string as Not an Issue string with comment: ''.
               new UIDefaults.LazyInputMap(new Object[] {
                       "RIGHT", "positiveUnitIncrement",
                    "KP_RIGHT", "positiveUnitIncrement",
            ...
            "SplitPane.dividerSize", Integer.valueOf(5), //Audit Issue: User marked 'SplitPane.dividerSize' string as Not an Issue string with comment: ''.
            ...
            "Table.gridColor", gray,  // grid line color //Audit Issue: User marked 'Table.gridColor' string as Not an Issue string with comment: ''.
    ...
    private Object[] getLazyValueDefaults() {
        ...
        Object progressBarBorder = new SwingLazyValue(
                              "com.sun.java.swing.plaf.windows.WindowsBorders",
                              "getProgressBarBorder"); //Audit Issue: User marked 'getProgressBarBorder' string as Not an Issue string with comment: ''.
        ...
        Object[] lazyDefaults = {
            ...
            "ProgressBar.border", progressBarBorder, //Audit Issue: User marked 'ProgressBar.border' string as Not an Issue string with comment: ''.
