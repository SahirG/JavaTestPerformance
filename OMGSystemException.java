...
public class OMGSystemException extends LogWrapperBase {
    ...
    public BAD_CONTEXT idlContextNotFound( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            ...
            doLog( Level.WARNING, "OMG.idlContextNotFound", //Audit Issue: User marked 'OMG.idlContextNotFound' string as Not an Issue string with comment: ''.
    ...
    public BAD_CONTEXT noMatchingIdlContext( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.noMatchingIdlContext", //Audit Issue: User marked 'OMG.noMatchingIdlContext' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_INV_ORDER invalidPiCall1( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.FINE )) {
            Object[] parameters = null ;
            doLog( Level.FINE, "OMG.invalidPiCall1", //Audit Issue: User marked 'OMG.invalidPiCall1' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_INV_ORDER invalidPiCall2( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.FINE )) {
            Object[] parameters = null ;
            doLog( Level.FINE, "OMG.invalidPiCall2", //Audit Issue: User marked 'OMG.invalidPiCall2' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_INV_ORDER invalidPiCall3( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.FINE )) {
            Object[] parameters = null ;
            doLog( Level.FINE, "OMG.invalidPiCall3", //Audit Issue: User marked 'OMG.invalidPiCall3' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_INV_ORDER invalidPiCall4( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.FINE )) {
            Object[] parameters = null ;
            doLog( Level.FINE, "OMG.invalidPiCall4", //Audit Issue: User marked 'OMG.invalidPiCall4' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM ridAlreadyDefined( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.ridAlreadyDefined", //Audit Issue: User marked 'OMG.ridAlreadyDefined' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM invalidObjectId( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.invalidObjectId", //Audit Issue: User marked 'OMG.invalidObjectId' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM typecodeBadRepid( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.typecodeBadRepid", //Audit Issue: User marked 'OMG.typecodeBadRepid' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM invalidServiceContextId( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.FINE )) {
            Object[] parameters = null ;
            doLog( Level.FINE, "OMG.invalidServiceContextId", //Audit Issue: User marked 'OMG.invalidServiceContextId' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM invalidComponentId( CompletionStatus cs, Throwable t, Object arg0) {
        ...
        if (logger.isLoggable( Level.FINE )) {
            Object[] parameters = new Object[1] ;
            parameters[0] = arg0 ;
            doLog( Level.FINE, "OMG.invalidComponentId", //Audit Issue: User marked 'OMG.invalidComponentId' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM invalidProfileId( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.invalidProfileId", //Audit Issue: User marked 'OMG.invalidProfileId' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM diiForImplicitOperation( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.diiForImplicitOperation", //Audit Issue: User marked 'OMG.diiForImplicitOperation' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM invalidStreamFormatVersion( CompletionStatus cs, Throwable t, Object arg0) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = new Object[1] ;
            parameters[0] = arg0 ;
            doLog( Level.WARNING, "OMG.invalidStreamFormatVersion", //Audit Issue: User marked 'OMG.invalidStreamFormatVersion' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.invalidStreamFormatVersion' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.invalidStreamFormatVersion' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.invalidStreamFormatVersion' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.invalidStreamFormatVersion' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.invalidStreamFormatVersion' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM notAValueoutputstream( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.notAValueoutputstream", //Audit Issue: User marked 'OMG.notAValueoutputstream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.notAValueoutputstream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.notAValueoutputstream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.notAValueoutputstream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.notAValueoutputstream' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public BAD_PARAM notAValueinputstream( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.notAValueinputstream", //Audit Issue: User marked 'OMG.notAValueinputstream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.notAValueinputstream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.notAValueinputstream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.notAValueinputstream' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'OMG.notAValueinputstream' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public MARSHAL rmiiiopOptionalDataIncompatible1( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.rmiiiopOptionalDataIncompatible1", //Audit Issue: User marked 'OMG.rmiiiopOptionalDataIncompatible1' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public MARSHAL rmiiiopOptionalDataIncompatible2( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.rmiiiopOptionalDataIncompatible2", //Audit Issue: User marked 'OMG.rmiiiopOptionalDataIncompatible2' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public MARSHAL rmiiiopOptionalDataIncompatible3( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.FINE )) {
            Object[] parameters = null ;
            doLog( Level.FINE, "OMG.rmiiiopOptionalDataIncompatible3", //Audit Issue: User marked 'OMG.rmiiiopOptionalDataIncompatible3' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
    ...
    public NO_IMPLEMENT diiLocalObject( CompletionStatus cs, Throwable t ) {
        ...
        if (logger.isLoggable( Level.WARNING )) {
            Object[] parameters = null ;
            doLog( Level.WARNING, "OMG.diiLocalObject", //Audit Issue: User marked 'OMG.diiLocalObject' string as Not an Issue string with comment: ''.
                parameters, OMGSystemException.class, exc ) ;
        }
