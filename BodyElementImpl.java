...
public abstract class BodyElementImpl
    ...
    public void setParentElement(SOAPElement element) throws SOAPException {
        if (! (element instanceof SOAPBody)) {
            log.severe("SAAJ0101.impl.parent.of.body.elem.mustbe.body"); //Audit Issue: User marked 'SAAJ0101.impl.parent.of.body.elem.mustbe.body' string as Not an Issue string with comment: ''.
