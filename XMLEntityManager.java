    ...
    public String setupCurrentEntity(String name, XMLInputSource xmlInputSource,
        ...
        if (reader == null) {
            ...
            // use specified encoding
                ...
                // in order to discover the byte order.
                else if (encoding.equals("ISO-10646-UCS-4")) { //Audit Issue: User marked 'ISO-10646-UCS-4' string as Not an Issue string with comment: ''.
                    final int[] b4 = new int[4];
                    int count = 0;
                    for (; count < 4; ++count) {
                        b4[count] = stream.read();
                ...
                // in order to discover the byte order.
                else if (encoding.equals("ISO-10646-UCS-2")) { //Audit Issue: User marked 'ISO-10646-UCS-2' string as Not an Issue string with comment: ''.
                    final int[] b4 = new int[4];
                    int count = 0;
                    for (; count < 4; ++count) {
                        b4[count] = stream.read();
    ...
    */
    ...
    public void test(){
        ...
        fEntityStorage.addExternalEntity("entityUsecase1",null,
                "/space/home/stax/sun/6thJan2004/zephyr/data/test.txt", //Audit Issue: User marked '/space/home/stax/sun/6thJan2004/zephyr/data/test.txt' string as Not an Issue string with comment: ''.
        ...
        fEntityStorage.addInternalEntity("ch","&#x00A9;"); //Audit Issue: User marked '&#x00A9;' string as Not an Issue string with comment: ''.
