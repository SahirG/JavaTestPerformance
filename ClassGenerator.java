...
public class ClassGenerator extends ClassGen {
    ...
    public ClassGenerator(String class_name, String super_class_name,
        ...
        if (stylesheet.isMultiDocument()) {
            ...
            _domClassSig = "Lcom/sun/org/apache/xalan/internal/xsltc/dom/MultiDOM;"; //Audit Issue: User marked 'Lcom/sun/org/apache/xalan/internal/xsltc/dom/MultiDOM;' string as Not an Issue string with comment: ''.
        }
        else {
