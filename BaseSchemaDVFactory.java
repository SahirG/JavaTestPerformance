...
public abstract class BaseSchemaDVFactory extends SchemaDVFactory {
    ...
    protected static void createBuiltInTypes(SymbolHash builtInTypes, XSSimpleTypeDecl baseAtomicType) {
        ...
        final String ID                = "ID"; //Audit Issue: User marked 'ID' string as Not an Issue string with comment: ''.
        final String IDREF             = "IDREF"; //Audit Issue: User marked 'IDREF' string as Not an Issue string with comment: ''.
        final String IDREFS            = "IDREFS"; //Audit Issue: User marked 'IDREFS' string as Not an Issue string with comment: ''.
        ...
        facets.maxInclusive = "0"; //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
        ...
        facets.maxInclusive = "9223372036854775807"; //Audit Issue: User marked '9223372036854775807' string as Not an Issue string with comment: ''.
        facets.minInclusive = "-9223372036854775808"; //Audit Issue: User marked '-9223372036854775808' string as Not an Issue string with comment: ''.
        ...
        facets.minInclusive =  "0" ; //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
        ...
        facets.maxInclusive = "18446744073709551615" ; //Audit Issue: User marked '18446744073709551615' string as Not an Issue string with comment: ''.
        ...
        facets.whiteSpace = XSSimpleType.WS_COLLAPSE;
        facets.pattern  = "([a-zA-Z]{1,8})(-[a-zA-Z0-9]{1,8})*"; //Audit Issue: User marked '([a-zA-Z]{1,8})(-[a-zA-Z0-9]{1,8})*' string as Not an Issue string with comment: ''.
