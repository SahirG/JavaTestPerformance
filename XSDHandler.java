...
public class XSDHandler {
            ...
            globalComp = DOMUtil.getNextSiblingElement(globalComp)) {
                ...
                if (DOMUtil.getLocalName(globalComp).equals(SchemaSymbols.ELT_ANNOTATION)) {
                    ...
                    if (!dependenciesCanOccur) {
                        reportSchemaError("s4s-elt-invalid-content.3", new Object [] {DOMUtil.getLocalName(globalComp)}, globalComp); //Audit Issue: User marked 's4s-elt-invalid-content.3' string as Not an Issue string with comment: ''.
                    }
        ...
        while (!schemasToProcess.empty()) {
            ...
            globalComp = DOMUtil.getNextVisibleSiblingElement(globalComp, fHiddenNodes)) {
                ...
                if (DOMUtil.getLocalName(globalComp).equals(SchemaSymbols.ELT_REDEFINE)) {
                    ...
                    reportSchemaError("s4s-elt-invalid-content.1", new Object [] {SchemaSymbols.ELT_SCHEMA, DOMUtil.getLocalName(globalComp)}, globalComp); //Audit Issue: User marked 's4s-elt-invalid-content.1' string as Not an Issue string with comment: ''.
                }
            } // end for
    ...
    private static final String[] COMP_TYPE = {
            ...
            "element declaration",
            "group",
            "identity constraint", //Audit Issue: User marked 'identity constraint' string as Not an Issue string with comment: ''.
            "notation",
            "type definition",
    };
