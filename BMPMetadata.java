...
public class BMPMetadata extends IIOMetadata implements BMPConstants {
    ...
    private Node getNativeTree() {
        ...
        addChildNode(root, "Width", new Integer(width)); //Audit Issue: User marked 'Width' string as Not an Issue string with comment: ''.
    ...
    protected IIOMetadataNode getStandardDataNode() {
        ...
        IIOMetadataNode subNode = new IIOMetadataNode("BitsPerSample"); //Audit Issue: User marked 'BitsPerSample' string as Not an Issue string with comment: ''.
