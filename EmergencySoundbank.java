...
public class EmergencySoundbank {
    ...
    private final static String[] general_midi_instruments = {
        ...
        "Kalimba",
        "Bag pipe",
        "Fiddle", //Audit Issue: User marked 'Fiddle' string as Not an Issue string with comment: ''.
        "Shanai",
        "Tinkle Bell",
        "Agogo",
        "Steel Drums",
    ...
    public static SF2Soundbank createSoundbank() throws Exception {
        ...
        newInstrument(sf2, "Gunshot/side_stick", new Patch(0, 127), side_stick); //Audit Issue: User marked 'Gunshot/side_stick' string as Not an Issue string with comment: ''.
