...
public class AOMEntry extends FSMImpl {
    ...
    public static final State INVALID = new StateImpl( "Invalid" ) ; //Audit Issue: User marked 'Invalid' string as Not an Issue string with comment: ''.
    ...
    public static final State VALID   = new StateImpl( "Valid" ) ; //Audit Issue: User marked 'Valid' string as Not an Issue string with comment: ''.
