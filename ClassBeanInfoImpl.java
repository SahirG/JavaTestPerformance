        ...
        if (factoryMethod == null){
           bean = ClassFactory.create0(jaxbType);
            ...
            if( jaxbType.isInstance(o) ){
                ...
                throw new InstantiationException("The factory method didn't return a correct object"); //Audit Issue: User marked 'The factory method didn't return a correct object' string as Not an Issue string with comment: ''.
            }
        }
