...
public class XIncludeHandler
    ...
    public final static String XINCLUDE_NS_URI =
        "http://www.w3.org/2001/XInclude".intern(); //Audit Issue: User marked 'http://www.w3.org/2001/XInclude' string as Not an Issue string with comment: ''.
    ...
    protected boolean handleIncludeElement(XMLAttributes attributes)
        ...
        if (href.length() == 0 && XINCLUDE_PARSE_XML.equals(parse)) {
            if (xpointer == null) {
                ...
                String reason = fXIncludeMessageFormatter.formatMessage(locale, "XPointerStreamability", null); //Audit Issue: User marked 'XPointerStreamability' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'XPointerStreamability' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'XPointerStreamability' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'XPointerStreamability' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'XPointerStreamability' string as Not an Issue string with comment: ''.
        ...
        try {
            ...
            if (hrefURI.getFragment() != null) {
                reportFatalError("HrefFragmentIdentifierIllegal", new Object[] {href}); //Audit Issue: User marked 'HrefFragmentIdentifierIllegal' string as Not an Issue string with comment: ''.
            }
        }
            ...
            if (href != newHref) {
                ...
                try {
                    ...
                    reportFatalError("HrefSyntacticallyInvalid", new Object[] {href}); //Audit Issue: User marked 'HrefSyntacticallyInvalid' string as Not an Issue string with comment: ''.
                }
            }
            else {
                reportFatalError("HrefSyntacticallyInvalid", new Object[] {href}); //Audit Issue: User marked 'HrefSyntacticallyInvalid' string as Not an Issue string with comment: ''.
        ...
        if (parse.equals(XINCLUDE_PARSE_XML)) {
            ...
            reportFatalError("InvalidParseValue", new Object[] { parse }); //Audit Issue: User marked 'InvalidParseValue' string as Not an Issue string with comment: ''.
        }
        return true;
    }
    ...
    protected boolean searchForRecursiveIncludes(XMLLocator includedSource) {
        ...
        if (includedSystemId == null) {
            try {
                ...
                reportFatalError("ExpandedSystemId"); //Audit Issue: User marked 'ExpandedSystemId' string as Not an Issue string with comment: ''.
            }
        }
