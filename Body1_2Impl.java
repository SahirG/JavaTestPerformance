...
public class Body1_2Impl extends BodyImpl {
    ...
    public SOAPFault addFault() throws SOAPException {
        if (hasAnyChildElement()) {
            log.severe("SAAJ0402.ver1_2.only.fault.allowed.in.body"); //Audit Issue: User marked 'SAAJ0402.ver1_2.only.fault.allowed.in.body' string as Not an Issue string with comment: ''.
    ...
    public void setEncodingStyle(String encodingStyle) throws SOAPException {
        log.severe("SAAJ0401.ver1_2.no.encodingstyle.in.body"); //Audit Issue: User marked 'SAAJ0401.ver1_2.no.encodingstyle.in.body' string as Not an Issue string with comment: ''.
