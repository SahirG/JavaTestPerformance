    ...
    private Class readClass() {
        ...
        if (debug) {
            dprint("readClass codebases: "
                   + codebases
                   + " rep Id: " //Audit Issue: User marked ' rep Id: ' string as Not an Issue string with comment: ''.
                   + classRepId);
        }
...
//     }
    ...
    private StringBuffer read_fixed_buffer() {
        ...
        while (more) {
            ...
            if (secondDigit == 12) {
                ...
                if ( ! wroteFirstDigit) {
                    // zero
                    return new StringBuffer("0.0"); //Audit Issue: User marked '0.0' string as Not an Issue string with comment: ''.
                } else {
                    // positive number
                    // done
                }
    ...
    private final static String _id = "IDL:omg.org/CORBA/DataInputStream:1.0"; //Audit Issue: User marked 'IDL:omg.org/CORBA/DataInputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataInputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataInputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataInputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataInputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataInputStream:1.0' string as Not an Issue string with comment: ''.
                                     ...
                                     String codebaseURL)
    {
        ...
        dprint("getClassFromString failed with rep id " //Audit Issue: User marked 'getClassFromString failed with rep id ' string as Not an Issue string with comment: ''.
               + repositoryIDString
               + " and codebase "
               + codebaseURL);
