...
public class CatalogManager {
  private static String pFiles         = "xml.catalog.files"; //Audit Issue: User marked 'xml.catalog.files' string as Not an Issue string with comment: ''.
  private static String pVerbosity     = "xml.catalog.verbosity";
  private static String pPrefer        = "xml.catalog.prefer"; //Audit Issue: User marked 'xml.catalog.prefer' string as Not an Issue string with comment: ''.
  private static String pStatic        = "xml.catalog.staticCatalog"; //Audit Issue: User marked 'xml.catalog.staticCatalog' string as Not an Issue string with comment: ''.
  private static String pAllowPI       = "xml.catalog.allowPI"; //Audit Issue: User marked 'xml.catalog.allowPI' string as Not an Issue string with comment: 'Not an issue'.
  ...
  private boolean queryRelativeCatalogs () {
    ...
    try {
      ...
      return (allow.equalsIgnoreCase("true")
              || allow.equalsIgnoreCase("yes") //Audit Issue: User marked 'yes' string as Not an Issue string with comment: ''.
  ...
  private boolean queryUseStaticCatalog () {
    ...
    return (staticCatalog.equalsIgnoreCase("true")
            || staticCatalog.equalsIgnoreCase("yes") //Audit Issue: User marked 'yes' string as Not an Issue string with comment: ''.
