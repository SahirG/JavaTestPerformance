...
public class AiffFileWriter extends SunFileWriter {
    ...
    public int write(AudioInputStream stream, AudioFileFormat.Type fileType, OutputStream out) throws IOException {
        ...
        if( stream.getFrameLength() == AudioSystem.NOT_SPECIFIED ) {
            throw new IOException("stream length not specified"); //Audit Issue: User marked 'stream length not specified' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'stream length not specified' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'stream length not specified' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'stream length not specified' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'stream length not specified' string as Not an Issue string with comment: ''.
        }
