...
public class _ActivatorStub extends org.omg.CORBA.portable.ObjectImpl implements com.sun.corba.se.spi.activation.Activator
{
  ...
  public void active (int serverId, com.sun.corba.se.spi.activation.Server serverObj) throws com.sun.corba.se.spi.activation.ServerNotRegistered
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request (Prudle_Localize("20__ActivatorStub.javaHardcodedString_0_pse13n"), true);
                ...
                String _id = $ex.getId ();
                if (_id.equals ("IDL:activation/ServerNotRegistered:1.0")) //Audit Issue: User marked 'IDL:activation/ServerNotRegistered:1.0' string as Not an Issue string with comment: ''.
  ...
  public void registerEndpoints (int serverId, String orbId, com.sun.corba.se.spi.activation.EndPointInfo[] endPointInfo) throws com.sun.corba.se.spi.activation.ServerNotRegistered, com.sun.corba.se.spi.activation.NoSuchEndPoint, com.sun.corba.se.spi.activation.ORBAlreadyRegistered
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request (Prudle_Localize("45__ActivatorStub.javaHardcodedString_1_pse13n"), true);
                com.sun.corba.se.spi.activation.ServerIdHelper.write ($out, serverId);
                ...
                if (_id.equals ("IDL:activation/ServerNotRegistered:1.0")) //Audit Issue: User marked 'IDL:activation/ServerNotRegistered:1.0' string as Not an Issue string with comment: ''.
                    throw com.sun.corba.se.spi.activation.ServerNotRegisteredHelper.read ($in);
                else if (_id.equals ("IDL:activation/NoSuchEndPoint:1.0")) //Audit Issue: User marked 'IDL:activation/NoSuchEndPoint:1.0' string as Not an Issue string with comment: ''.
                    throw com.sun.corba.se.spi.activation.NoSuchEndPointHelper.read ($in);
                else if (_id.equals ("IDL:activation/ORBAlreadyRegistered:1.0")) //Audit Issue: User marked 'IDL:activation/ORBAlreadyRegistered:1.0' string as Not an Issue string with comment: ''.
  ...
  public int[] getActiveServers ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request (Prudle_Localize("75__ActivatorStub.javaHardcodedString_2_pse13n"), true);
                $in = _invoke ($out);
  ...
  public void activate (int serverId) throws com.sun.corba.se.spi.activation.ServerAlreadyActive, com.sun.corba.se.spi.activation.ServerNotRegistered, com.sun.corba.se.spi.activation.ServerHeldDown
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request (Prudle_Localize("96__ActivatorStub.javaHardcodedString_3_pse13n"), true);
                com.sun.corba.se.spi.activation.ServerIdHelper.write ($out, serverId);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:activation/ServerAlreadyActive:1.0")) //Audit Issue: User marked 'IDL:activation/ServerAlreadyActive:1.0' string as Not an Issue string with comment: ''.
                    throw com.sun.corba.se.spi.activation.ServerAlreadyActiveHelper.read ($in);
                else if (_id.equals ("IDL:activation/ServerNotRegistered:1.0")) //Audit Issue: User marked 'IDL:activation/ServerNotRegistered:1.0' string as Not an Issue string with comment: ''.
                    throw com.sun.corba.se.spi.activation.ServerNotRegisteredHelper.read ($in);
                else if (_id.equals ("IDL:activation/ServerHeldDown:1.0")) //Audit Issue: User marked 'IDL:activation/ServerHeldDown:1.0' string as Not an Issue string with comment: ''.
  ...
  public void shutdown (int serverId) throws com.sun.corba.se.spi.activation.ServerNotActive, com.sun.corba.se.spi.activation.ServerNotRegistered
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request (Prudle_Localize("124__ActivatorStub.javaHardcodedString_4_pse13n"), true);
                com.sun.corba.se.spi.activation.ServerIdHelper.write ($out, serverId);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:activation/ServerNotActive:1.0")) //Audit Issue: User marked 'IDL:activation/ServerNotActive:1.0' string as Not an Issue string with comment: ''.
  ...
  public void install (int serverId) throws com.sun.corba.se.spi.activation.ServerNotRegistered, com.sun.corba.se.spi.activation.ServerHeldDown, com.sun.corba.se.spi.activation.ServerAlreadyInstalled
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request (Prudle_Localize("150__ActivatorStub.javaHardcodedString_5_pse13n"), true);
                com.sun.corba.se.spi.activation.ServerIdHelper.write ($out, serverId);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                if (_id.equals ("IDL:activation/ServerNotRegistered:1.0")) //Audit Issue: User marked 'IDL:activation/ServerNotRegistered:1.0' string as Not an Issue string with comment: ''.
                    ...
                    throw com.sun.corba.se.spi.activation.ServerHeldDownHelper.read ($in);
                else if (_id.equals ("IDL:activation/ServerAlreadyInstalled:1.0")) //Audit Issue: User marked 'IDL:activation/ServerAlreadyInstalled:1.0' string as Not an Issue string with comment: ''.
  ...
  public String[] getORBNames (int serverId) throws com.sun.corba.se.spi.activation.ServerNotRegistered
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request (Prudle_Localize("178__ActivatorStub.javaHardcodedString_6_pse13n"), true);
                com.sun.corba.se.spi.activation.ServerIdHelper.write ($out, serverId);
                $in = _invoke ($out);
  ...
  public void uninstall (int serverId) throws com.sun.corba.se.spi.activation.ServerNotRegistered, com.sun.corba.se.spi.activation.ServerHeldDown, com.sun.corba.se.spi.activation.ServerAlreadyUninstalled
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request (Prudle_Localize("203__ActivatorStub.javaHardcodedString_7_pse13n"), true);
                com.sun.corba.se.spi.activation.ServerIdHelper.write ($out, serverId);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                if (_id.equals ("IDL:activation/ServerNotRegistered:1.0")) //Audit Issue: User marked 'IDL:activation/ServerNotRegistered:1.0' string as Not an Issue string with comment: ''.
                    ...
                    throw com.sun.corba.se.spi.activation.ServerHeldDownHelper.read ($in);
                else if (_id.equals ("IDL:activation/ServerAlreadyUninstalled:1.0")) //Audit Issue: User marked 'IDL:activation/ServerAlreadyUninstalled:1.0' string as Not an Issue string with comment: ''.
  ...
  private static String[] __ids = {
    Prudle_Localize("227__ActivatorStub.javaHardcodedString_8_pse13n")}; //Audit Issue: User marked 'IDL:activation/Activator:1.0' string as Not an Issue string with comment: ''.
