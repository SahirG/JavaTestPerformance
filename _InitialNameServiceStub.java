...
public class _InitialNameServiceStub extends org.omg.CORBA.portable.ObjectImpl implements com.sun.corba.se.spi.activation.InitialNameService
{
  ...
  public void bind (String name, org.omg.CORBA.Object obj, boolean isPersistant) throws com.sun.corba.se.spi.activation.InitialNameServicePackage.NameAlreadyBound
  {
            ...
            try {
                ...
                String _id = $ex.getId ();
                if (_id.equals ("IDL:activation/InitialNameService/NameAlreadyBound:1.0")) //Audit Issue: User marked 'IDL:activation/InitialNameService/NameAlreadyBound:1.0' string as Not an Issue string with comment: ''.
  ...
  private static String[] __ids = {
    "IDL:activation/InitialNameService:1.0"}; //Audit Issue: User marked 'IDL:activation/InitialNameService:1.0' string as Not an Issue string with comment: ''.
