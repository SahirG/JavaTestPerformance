        ...
        if(qName.startsWith("xmlns:") || "xmlns".equals(qName))
          {
            ...
            appendNSDeclaration(
                                    ...
                                    atts.getType(i).equalsIgnoreCase("ID")); //Audit Issue: User marked 'ID' string as Not an Issue string with comment: ''.
          }
      }
...
//      int charStringStart=0,charStringLength=0;
                           ...
                           boolean isID)
  {
    ...
    final int namespaceForNamespaces=m_nsNames.stringToIndex("http://www.w3.org/2000/xmlns/"); //Audit Issue: User marked 'http://www.w3.org/2000/xmlns/' string as Not an Issue string with comment: ''.

    // W0  High:  Namespace  Low:  Node Type
    int w0 = NAMESPACE_NODE | (m_nsNames.stringToIndex("http://www.w3.org/2000/xmlns/")<<16); //Audit Issue: User marked 'http://www.w3.org/2000/xmlns/' string as Not an Issue string with comment: ''.
