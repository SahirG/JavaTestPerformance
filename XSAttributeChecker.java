...
public class XSAttributeChecker {
    ...
    public Object[] checkAttributes(Element element, boolean isGlobal,
        ...
        if (attrList == null) {
            ...
            reportSchemaError ("s4s-elt-invalid", new Object[] {elName}, element); //Audit Issue: User marked 's4s-elt-invalid' string as Not an Issue string with comment: ''.
            return null;
        }
        ...
        for (int i = 0; i < length; i++) {
            ...
            try {
                ...
                reportSchemaError ("s4s-att-invalid-value", //Audit Issue: User marked 's4s-att-invalid-value' string as Not an Issue string with comment: ''.
    ...
    private Object validate(Object[] attrValues, String attr, String ivalue, int dvIndex,
        ...
        case DT_BOOLEAN:
            if (value.equals(SchemaSymbols.ATTVAL_FALSE) ||
                ...
                throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.1", new Object[]{value, "boolean"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.1' string as Not an Issue string with comment: ''.
            }
            break;
        case DT_NONNEGINT:
            try {
                ...
                throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.1", new Object[]{value, "nonNegativeInteger"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.1' string as Not an Issue string with comment: ''.
            }
        ...
        case DT_POSINT:
            try {
                ...
                throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.1", new Object[]{value, "positiveInteger"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.1' string as Not an Issue string with comment: ''.
            }
            if (((XInt)retValue).intValue() <= 0)
                throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.1", new Object[]{value, "positiveInteger"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.1' string as Not an Issue string with comment: ''.
            break;
            ...
            if (value.equals (SchemaSymbols.ATTVAL_POUNDALL)) {
                ...
                while (t.hasMoreTokens()) {
                    ...
                    if (token.equals (SchemaSymbols.ATTVAL_EXTENSION)) {
                        ...
                        throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3", new Object[]{value, "(#all | List of (extension | restriction | substitution))"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.3' string as Not an Issue string with comment: ''.
                    }
                }
            }
            ...
            if (value.equals (SchemaSymbols.ATTVAL_POUNDALL)) {
                ...
                while (t.hasMoreTokens()) {
                    ...
                    if (token.equals (SchemaSymbols.ATTVAL_EXTENSION)) {
                        ...
                        throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3", new Object[]{value, "(#all | List of (extension | restriction))"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.3' string as Not an Issue string with comment: ''.
                    }
                }
            }
            retValue = fXIntPool.getXInt(choice);
            ...
            if (value.equals (SchemaSymbols.ATTVAL_POUNDALL)) {
                ...
                while (t.hasMoreTokens()) {
                    ...
                    if (token.equals (SchemaSymbols.ATTVAL_LIST)) {
                        ...
                        throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3", new Object[]{value, "(#all | List of (list | union | restriction))"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.3' string as Not an Issue string with comment: ''.
                    }
                }
            }
            retValue = fXIntPool.getXInt(choice);
            ...
            if (value.equals (SchemaSymbols.ATTVAL_POUNDALL)) {
                ...
                while (t.hasMoreTokens()) {
                    ...
                    if (token.equals (SchemaSymbols.ATTVAL_EXTENSION)) {
                        ...
                        throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3", new Object[]{value, "(#all | List of (extension | restriction | list | union))"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.3' string as Not an Issue string with comment: ''.
                    }
                }
            }
            retValue = fXIntPool.getXInt(choice);
        ...
        case DT_MAXOCCURS:
            ...
            if (value.equals(SchemaSymbols.ATTVAL_UNBOUNDED)) {
                ...
                try {
                    ...
                    throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3", new Object[]{value, "(nonNegativeInteger | unbounded)"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.3' string as Not an Issue string with comment: ''.
                }
            }
            break;
        case DT_MAXOCCURS1:
        ...
        case DT_MEMBERTYPES:
            ...
            try {
                ...
                throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.2", new Object[]{value, "(List of QName)"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.2' string as Not an Issue string with comment: ''.
            }
            break;
        case DT_MINOCCURS1:
            // minOccurs = (0 | 1)
            if (value.equals("0")) //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
                retValue = fXIntPool.getXInt(0);
            else if (value.equals("1"))
                retValue = fXIntPool.getXInt(1);
            else
                throw new InvalidDatatypeValueException("cvc-enumeration-valid", //Audit Issue: User marked 'cvc-enumeration-valid' string as Not an Issue string with comment: ''.
                                                        new Object[]{value, "(0 | 1)"}); //Audit Issue: User marked '(0 | 1)' string as Not an Issue string with comment: ''.
            break;
        case DT_NAMESPACE:
            ...
            if (value.equals(SchemaSymbols.ATTVAL_TWOPOUNDANY)) {
                ...
                try {
                    ...
                    throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.3", new Object[]{value, "((##any | ##other) | List of (anyURI | (##targetNamespace | ##local)) )"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.3' string as Not an Issue string with comment: ''.
                }
