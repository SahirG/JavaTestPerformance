...
public class AnyURIDV extends TypeValidator {
    ...
    public Object getActualValue(String content, ValidationContext context) throws InvalidDatatypeValueException {
        ...
        try {
            ...
            throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.1", new Object[]{content, "anyURI"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.1' string as Not an Issue string with comment: ''.
        }
