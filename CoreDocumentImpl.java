...
extends ParentNode implements Document  {
        ...
        if (errorChecking && !isXMLName(name,xml11Version)) {
            String msg =
                DOMMessageFormatter.formatMessage(
                    ...
                    "INVALID_CHARACTER_ERR", //Audit Issue: User marked 'INVALID_CHARACTER_ERR' string as Not an Issue string with comment: ''.
                    null);
    ...
    throws DOMException {
        ...
        if (errorChecking && !isXMLName(tagName,xml11Version)) {
            String msg = DOMMessageFormatter.formatMessage(DOMMessageFormatter.DOM_DOMAIN, "INVALID_CHARACTER_ERR", null); //Audit Issue: User marked 'INVALID_CHARACTER_ERR' string as Not an Issue string with comment: ''.
            throw new DOMException(DOMException.INVALID_CHARACTER_ERR, msg);
        }
                    ...
                    if (namespaceURI == null) {
                        if (errorChecking) {
                            ...
                            if (!isXMLName(name,xml11Version)) {
                                String msg = DOMMessageFormatter.formatMessage(
                                        DOMMessageFormatter.DOM_DOMAIN,
                                        "INVALID_CHARACTER_ERR", null); //Audit Issue: User marked 'INVALID_CHARACTER_ERR' string as Not an Issue string with comment: ''.
