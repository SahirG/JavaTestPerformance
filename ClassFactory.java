    ...
    public static void cleanCache() {
        if (tls != null) {
            try {
                ...
                logger.log(Level.WARNING, "Unable to clean Thread Local cache of classes used in Unmarshaller: {0}", e.getLocalizedMessage()); //Audit Issue: User marked 'Unable to clean Thread Local cache of classes used in Unmarshaller: {0}' string as Not an Issue string with comment: ''.
            }
        }
    }
