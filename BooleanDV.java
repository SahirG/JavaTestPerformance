...
public class BooleanDV extends TypeValidator{
    ...
    public Object getActualValue(String content, ValidationContext context) throws InvalidDatatypeValueException {
        ...
        if (content.equals(fValueSpace[0]) || content.equals(fValueSpace[2]))
            ...
            throw new InvalidDatatypeValueException("cvc-datatype-valid.1.2.1", new Object[]{content, "boolean"}); //Audit Issue: User marked 'cvc-datatype-valid.1.2.1' string as Not an Issue string with comment: ''.
        return ret;
    }
