    ...
    private void decode() throws IOException {
        ...
        while (got < 4) {
            ...
            if (i == -1) {
                ...
                throw new IOException("Error in encoded stream, got " + got); //Audit Issue: User marked 'Error in encoded stream, got ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Error in encoded stream, got ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Error in encoded stream, got ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Error in encoded stream, got ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'Error in encoded stream, got ' string as Not an Issue string with comment: ''.
            }
