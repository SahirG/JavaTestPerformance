...
abstract class AbstractDataLine extends AbstractLine implements DataLine {
    ...
    public void open(AudioFormat format, int bufferSize) throws LineUnavailableException {
        ...
        synchronized (mixer) {
            if (Printer.trace) Printer.trace("> AbstractDataLine.open(format, bufferSize) (class: "+getClass().getName()); //Audit Issue: User marked '> AbstractDataLine.open(format, bufferSize) (class: ' string as Not an Issue string with comment: ''.
            ...
            if (!isOpen()) {
                ...
                if (Printer.debug) Printer.debug("  need to open the mixer..."); //Audit Issue: User marked '  need to open the mixer...' string as Not an Issue string with comment: ''.
                ...
                if (Printer.debug) Printer.debug("  dataline already open"); //Audit Issue: User marked '  dataline already open' string as Not an Issue string with comment: ''.
                ...
                if (!format.matches(getFormat())) {
                    throw new IllegalStateException("Line is already open with format " + getFormat() + //Audit Issue: User marked 'Line is already open with format ' string as Not an Issue string with comment: ''.
                                                    " and bufferSize " + getBufferSize()); //Audit Issue: User marked ' and bufferSize ' string as Not an Issue string with comment: ''.
                }
            ...
            if (Printer.trace) Printer.trace("< AbstractDataLine.open(format, bufferSize) completed"); //Audit Issue: User marked '< AbstractDataLine.open(format, bufferSize) completed' string as Not an Issue string with comment: ''.
        }
    }
     ...
     */
    public void drain() {
        if (Printer.trace) Printer.trace("AbstractDataLine: drain"); //Audit Issue: User marked 'AbstractDataLine: drain' string as Not an Issue string with comment: ''.
    }
     ...
     */
    public void flush() {
        if (Printer.trace) Printer.trace("AbstractDataLine: flush"); //Audit Issue: User marked 'AbstractDataLine: flush' string as Not an Issue string with comment: ''.
    }
    ...
    public void start() {
        //$$fb 2001-10-09: Bug #4517739: avoiding deadlock by synchronizing to mixer !
        synchronized(mixer) {
            if (Printer.trace) Printer.trace("> "+getClass().getName()+".start() - AbstractDataLine"); //Audit Issue: User marked '.start() - AbstractDataLine' string as Not an Issue string with comment: ''.
    ...
    public void stop() {
        ...
        //$$fb 2001-10-09: Bug #4517739: avoiding deadlock by synchronizing to mixer !
        synchronized(mixer) {
            if (Printer.trace) Printer.trace("> "+getClass().getName()+".stop() - AbstractDataLine"); //Audit Issue: User marked '.stop() - AbstractDataLine' string as Not an Issue string with comment: ''.
    ...
    protected void setActive(boolean active) {
        ...
        if (Printer.trace) Printer.trace("> AbstractDataLine: setActive(" + active + ")"); //Audit Issue: User marked '> AbstractDataLine: setActive(' string as Not an Issue string with comment: ''.
    ...
    protected void setStarted(boolean started) {
        ...
        if (Printer.trace) Printer.trace("> AbstractDataLine: setStarted(" + started + ")"); //Audit Issue: User marked '> AbstractDataLine: setStarted(' string as Not an Issue string with comment: ''.
        ...
        if (Printer.trace) Printer.trace("< AbstractDataLine: setStarted completed"); //Audit Issue: User marked '< AbstractDataLine: setStarted completed' string as Not an Issue string with comment: ''.
    }
    ...
    protected void setEOM() {
        ...
        if (Printer.trace) Printer.trace("> AbstractDataLine: setEOM()"); //Audit Issue: User marked '> AbstractDataLine: setEOM()' string as Not an Issue string with comment: ''.
        //$$fb 2002-04-21: sometimes, 2 STOP events are generated.
        // better use setStarted() to send STOP event.
        setStarted(false);
        if (Printer.trace) Printer.trace("< AbstractDataLine: setEOM() completed"); //Audit Issue: User marked '< AbstractDataLine: setEOM() completed' string as Not an Issue string with comment: ''.
    }
    ...
    public void open() throws LineUnavailableException {
        ...
        if (Printer.trace) Printer.trace("> "+getClass().getName()+".open() - AbstractDataLine"); //Audit Issue: User marked '.open() - AbstractDataLine' string as Not an Issue string with comment: ''.
    ...
    public void close() {
        //$$fb 2001-10-09: Bug #4517739: avoiding deadlock by synchronizing to mixer !
        synchronized (mixer) {
            if (Printer.trace) Printer.trace("> "+getClass().getName()+".close() - in AbstractDataLine."); //Audit Issue: User marked '.close() - in AbstractDataLine.' string as Not an Issue string with comment: ''.
