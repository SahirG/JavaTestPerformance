...
public class CDATAImpl
    ...
    public void setParentElement(SOAPElement parent) throws SOAPException {
        if (parent == null) {
            log.severe("SAAJ0145.impl.no.null.to.parent.elem"); //Audit Issue: User marked 'SAAJ0145.impl.no.null.to.parent.elem' string as Not an Issue string with comment: ''.
