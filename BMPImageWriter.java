    ...
    private void writeEmbedded(IIOImage image,
        ...
        if (writer != null) {
            if (embedded_stream == null) {
                throw new RuntimeException("No stream for writing embedded image!"); //Audit Issue: User marked 'No stream for writing embedded image!' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No stream for writing embedded image!' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No stream for writing embedded image!' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No stream for writing embedded image!' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'No stream for writing embedded image!' string as Not an Issue string with comment: ''.
            }
