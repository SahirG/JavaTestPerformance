    ...
    protected synchronized void beginRowAction(SnmpMibSubRequest req,
        ...
        default:
            if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                SNMP_ADAPTOR_LOGGER.logp(Level.FINEST,
                        SnmpMibTable.class.getName(),
                        "beginRowAction", "Invalid RowStatus value for row[" + //Audit Issue: User marked 'Invalid RowStatus value for row[' string as Not an Issue string with comment: ''.
    ...
    protected void endRowAction(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        default:
            if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                SNMP_ADAPTOR_LOGGER.logp(Level.FINEST,
                        SnmpMibTable.class.getName(),
                        "endRowAction", "Invalid RowStatus value for row[" + //Audit Issue: User marked 'Invalid RowStatus value for row[' string as Not an Issue string with comment: ''.
                        rowOid + "] : specified RowStatus = " + action);
            }
