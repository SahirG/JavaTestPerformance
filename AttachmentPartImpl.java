    ...
    public void setRawContentBytes(
        ...
        try {
            ...
            log.log(Level.SEVERE,
                "SAAJ0576.soap.attachment.setrawcontent.exception", e); //Audit Issue: User marked 'SAAJ0576.soap.attachment.setrawcontent.exception' string as Not an Issue string with comment: ''.
            throw new SOAPExceptionImpl(e.getLocalizedMessage());
        }
    }
    ...
    public  InputStream getRawContent() throws SOAPException {
        ...
        if (rawContent != null) {
            try {
                ...
                log.log(Level.SEVERE,"SAAJ0577.soap.attachment.getrawcontent.exception", e); //Audit Issue: User marked 'SAAJ0577.soap.attachment.getrawcontent.exception' string as Not an Issue string with comment: ''.
                throw new SOAPExceptionImpl(e.getLocalizedMessage());
            }
        } else if (dataHandler != null) {
            try {
                ...
                log.severe("SAAJ0574.soap.attachment.datahandler.ioexception"); //Audit Issue: User marked 'SAAJ0574.soap.attachment.datahandler.ioexception' string as Not an Issue string with comment: ''.
                throw new SOAPExceptionImpl("DataHandler error" + e);
            }
        } else {
            log.severe("SAAJ0572.soap.no.content.for.attachment"); //Audit Issue: User marked 'SAAJ0572.soap.no.content.for.attachment' string as Not an Issue string with comment: ''.
            throw new SOAPExceptionImpl("No data handler/content associated with this attachment");
        }
    }
    ...
    public  byte[] getRawContentBytes() throws SOAPException {
        ...
        if (mimePart != null) {
            try {
                ...
                log.log(Level.SEVERE,"SAAJ0577.soap.attachment.getrawcontent.exception", ex); //Audit Issue: User marked 'SAAJ0577.soap.attachment.getrawcontent.exception' string as Not an Issue string with comment: ''.
