...
{
    private static String  _id = "IDL:omg.org/CORBA/AttributeMode:1.0"; //Audit Issue: User marked 'IDL:omg.org/CORBA/AttributeMode:1.0' string as Not an Issue string with comment: ''.
