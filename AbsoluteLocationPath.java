    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        if (_path != null) {
            final int initAI = cpg.addMethodref(ABSOLUTE_ITERATOR,
                                                "<init>", //Audit Issue: User marked '<init>' string as Not an Issue string with comment: ''.
                                                "("
                                                + NODE_ITERATOR_SIG
            ...
            LocalVariableGen relPathIterator
                    = methodGen.addLocalVariable("abs_location_path_tmp", //Audit Issue: User marked 'abs_location_path_tmp' string as Not an Issue string with comment: ''.
            ...
            final int gitr = cpg.addInterfaceMethodref(DOM_INTF,
                                                       "getIterator", //Audit Issue: User marked 'getIterator' string as Not an Issue string with comment: ''.
                                                       "()"+NODE_ITERATOR_SIG);
