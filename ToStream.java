...
abstract public class ToStream extends SerializerBase
{
    ...
    {
        final java.io.Writer writer = m_writer;
        writer.write("<!ENTITY "); //Audit Issue: User marked '<!ENTITY ' string as Not an Issue string with comment: ''.
        writer.write(name);
        writer.write(" \"");
        writer.write(value);
        writer.write("\">");
        ...
        throws UnsupportedEncodingException
    {
        ...
        if (encoding.equalsIgnoreCase("UTF-8"))
        {
            ...
            encoding.equals("WINDOWS-1250")
                || encoding.equals("US-ASCII") //Audit Issue: User marked 'US-ASCII' string as Not an Issue string with comment: ''.
                || encoding.equals("ASCII")) //Audit Issue: User marked 'ASCII' string as Not an Issue string with comment: ''.
        {
        ...
        throws SAXException
    {
        try {
            ...
            m_writer.write("<!ENTITY "); //Audit Issue: User marked '<!ENTITY ' string as Not an Issue string with comment: ''.
            m_writer.write(name);
            if (publicId != null) {
        ...
        if (ns != null && ns.length() > 0)
        {
            ...
            if (index > 0)
            {
                ...
                else
                {
                    ...
                    this.addAttribute(
                        "http://www.w3.org/2000/xmlns/", //Audit Issue: User marked 'http://www.w3.org/2000/xmlns/' string as Not an Issue string with comment: ''.
                        prefixFromRawName,
