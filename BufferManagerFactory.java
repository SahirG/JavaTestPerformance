    ...
    public static BufferManagerRead newBufferManagerRead(
        ...
        switch (strategy) {
            ...
            case BufferManagerFactory.COLLECT:
                throw new INTERNAL("Collect strategy invalid for reading"); //Audit Issue: User marked 'Collect strategy invalid for reading' string as Not an Issue string with comment: ''.
