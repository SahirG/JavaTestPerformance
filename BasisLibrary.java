...
public final class BasisLibrary {
                                        ...
                                        Translet translet, DOM dom)
    {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (dtmManager != null) {
                ...
                runTimeError(RUN_TIME_INTERNAL_ERR, "need MultiDOM"); //Audit Issue: User marked 'need MultiDOM' string as Not an Issue string with comment: ''.
                return null;
            }
            dtmHandles[i] = handle;
            System.out.println("Node " + i + " has handle 0x" + //Audit Issue: User marked ' has handle 0x' string as Not an Issue string with comment: ''.
    ...
    public static final String INVALID_ARGUMENT_ERR =
                                           "INVALID_ARGUMENT_ERR"; //Audit Issue: User marked 'INVALID_ARGUMENT_ERR' string as Not an Issue string with comment: ''.
