...
final public class LdapCtx extends ComponentDirContext
   ...
   // getAttributes/modifyAttributes
    ...
    private static int convertToLdapModCode(int mod_op) {
        ...
        default:
            throw new IllegalArgumentException("Invalid modification code"); //Audit Issue: User marked 'Invalid modification code' string as Not an Issue string with comment: ''.
        }
    }
