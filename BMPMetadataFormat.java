...
public class BMPMetadataFormat extends IIOMetadataFormatImpl {
    ...
    private BMPMetadataFormat() {
        ...
        addAttribute("ImageDescriptor", "width", //Audit Issue: User marked 'width' string as Not an Issue string with comment: ''.
                     DATATYPE_INTEGER, true, null,
                     "0", "65535", true, true); //Audit Issue: User marked '0, 65535' string as Not an Issue string with comment: ''. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
        ...
        addAttribute("PaletteEntry", "index",
                     DATATYPE_INTEGER, true, null,
                     "0", "255", true, true); //Audit Issue: User marked '0, 255' string as Not an Issue string with comment: ''. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
