...
public class _RepositoryStub extends org.omg.CORBA.portable.ObjectImpl implements com.sun.corba.se.spi.activation.Repository
{
  ...
  public int registerServer (com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef serverDef) throws com.sun.corba.se.spi.activation.ServerAlreadyRegistered, com.sun.corba.se.spi.activation.BadServerDefinition
  {
            ...
            try {
                ...
                String _id = $ex.getId ();
                if (_id.equals ("IDL:activation/ServerAlreadyRegistered:1.0")) //Audit Issue: User marked 'IDL:activation/ServerAlreadyRegistered:1.0' string as Not an Issue string with comment: ''.
                    throw com.sun.corba.se.spi.activation.ServerAlreadyRegisteredHelper.read ($in);
                else if (_id.equals ("IDL:activation/BadServerDefinition:1.0")) //Audit Issue: User marked 'IDL:activation/BadServerDefinition:1.0' string as Not an Issue string with comment: ''.
  ...
  public int getServerID (String applicationName) throws com.sun.corba.se.spi.activation.ServerNotRegistered
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getServerID", true); //Audit Issue: User marked 'getServerID' string as Not an Issue string with comment: ''.
  ...
  private static String[] __ids = {
    "IDL:activation/Repository:1.0"}; //Audit Issue: User marked 'IDL:activation/Repository:1.0' string as Not an Issue string with comment: ''.
