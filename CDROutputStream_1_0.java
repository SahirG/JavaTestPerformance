...
//                for all write operations in this file.
    ...
    public void start_block() {
        if (debug) {
            dprint("CDROutputStream_1_0 start_block, position" + bbwi.position()); //Audit Issue: User marked 'CDROutputStream_1_0 start_block, position' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, position' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, position' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, position' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, position' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, position' string as Not an Issue string with comment: ''.
        }
        ...
        if (debug) {
            dprint("CDROutputStream_1_0 start_block, blockSizeIndex " //Audit Issue: User marked 'CDROutputStream_1_0 start_block, blockSizeIndex ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, blockSizeIndex ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, blockSizeIndex ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, blockSizeIndex ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, blockSizeIndex ' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0 start_block, blockSizeIndex ' string as Not an Issue string with comment: ''.
                   + blockSizeIndex);
        }
    ...
    public void end_block() {
        if (debug) {
            dprint("CDROutputStream_1_0.java end_block"); //Audit Issue: User marked 'CDROutputStream_1_0.java end_block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block' string as Not an Issue string with comment: ''.
        }
        ...
        if (debug) {
            dprint("CDROutputStream_1_0.java end_block, in a block"); //Audit Issue: User marked 'CDROutputStream_1_0.java end_block, in a block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block, in a block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block, in a block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block, in a block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block, in a block' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'CDROutputStream_1_0.java end_block, in a block' string as Not an Issue string with comment: ''.
        }
    ...
    private final static String _id = "IDL:omg.org/CORBA/DataOutputStream:1.0"; //Audit Issue: User marked 'IDL:omg.org/CORBA/DataOutputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataOutputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataOutputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataOutputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataOutputStream:1.0' string as Not an Issue string with comment: ''. //Audit Issue: User marked 'IDL:omg.org/CORBA/DataOutputStream:1.0' string as Not an Issue string with comment: ''.
        ...
        try {
            ...
            for (int i = 0; i < bbwi.position(); i += 16) {
                ...
                while (j < 16 && j + i < bbwi.position()) {
                    ...
                    if (hex.length() == 1)
                        hex = "0" + hex; //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
...
*/
    ...
    public void start_value(String rep_id) {
        ...
        if (debug) {
            dprint("start_value w/ rep id " //Audit Issue: User marked 'start_value w/ rep id ' string as Not an Issue string with comment: ''.
                   + rep_id
                   + " called at pos "
                   + get_offset()
                   + " position "
    ...
    public void close() throws IOException
    {
        ...
        if (getByteBufferWithInfo() != null && getByteBuffer() != null)
        {
            ...
            if (debug)
            {
                ...
                sb.append(".close - releasing ByteBuffer id ("); //Audit Issue: User marked '.close - releasing ByteBuffer id (' string as Not an Issue string with comment: ''.
