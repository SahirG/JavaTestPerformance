...
public abstract class AbstractMidiDeviceProvider extends MidiDeviceProvider {
     ...
     */
    static {
        if (Printer.trace) Printer.trace("AbstractMidiDeviceProvider: static"); //Audit Issue: User marked 'AbstractMidiDeviceProvider: static' string as Not an Issue string with comment: ''.
        Platform.initialize();
        enabled = Platform.isMidiIOEnabled();
        if (Printer.trace) Printer.trace("AbstractMidiDeviceProvider: enabled: " + enabled); //Audit Issue: User marked 'AbstractMidiDeviceProvider: enabled: ' string as Not an Issue string with comment: ''.
    ...
    public MidiDevice getDevice(MidiDevice.Info info) {
        ...
        throw new IllegalArgumentException("MidiDevice " + info.toString() //Audit Issue: User marked 'MidiDevice ' string as Not an Issue string with comment: ''.
                                           + " not supported by this provider."); //Audit Issue: User marked ' not supported by this provider.' string as Not an Issue string with comment: ''.
    }
