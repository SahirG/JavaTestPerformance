...
public abstract class AnyNodeCounter extends NodeCounter {
    ...
    public String getCounter() {
        ...
        if (_value != Integer.MIN_VALUE) {
            //See Errata E24
            if (_value == 0) return "0"; //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'. //Audit Issue: User marked '0' string as Not an Issue string with comment: 'Regex Matched as mention in IgnoreMatchingString'.
