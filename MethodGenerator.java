...
public class MethodGenerator extends MethodGen
    ...
    private static final String START_ELEMENT_SIG
        = "(" + STRING_SIG + ")V"; //Audit Issue: User marked ')V' string as Not an Issue string with comment: ''.
    ...
    public MethodGenerator(int access_flags, Type return_type,
        ...
        final int attribute =
            cpg.addInterfaceMethodref(TRANSLET_OUTPUT_INTERFACE,
                                      ...
                                      + STRING_SIG
                                      + STRING_SIG
                                      + ")V"); //Audit Issue: User marked ')V' string as Not an Issue string with comment: ''.
    ...
    public Method[] outlineChunks(ClassGenerator classGen,
        ...
        if (originalMethodName.equals("<init>")) { //Audit Issue: User marked '<init>' string as Not an Issue string with comment: ''.
    ...
    private Method outline(InstructionHandle first, InstructionHandle last,
        ...
        oldMethCopyInIL.append(
            new INVOKESPECIAL(cpg.addMethodref(argTypeName, "<init>", "()V"))); //Audit Issue: User marked '<init>' string as Not an Issue string with comment: ''.
