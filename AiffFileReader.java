        ...
        while (!ssndFound) {
            ...
            case AiffFileFormat.COMM_MAGIC:
                ...
                if ((!aifc && chunkLen < 18) || (aifc && chunkLen < 22)) {
                    throw new UnsupportedAudioFileException("Invalid AIFF/COMM chunksize"); //Audit Issue: User marked 'Invalid AIFF/COMM chunksize' string as Not an Issue string with comment: ''.
                }
                // Read header info.
                ...
                if (aifc) {
                    ...
                    case AiffFileFormat.AIFC_ULAW:
                        ...
                        break;
                    default:
                        throw new UnsupportedAudioFileException("Invalid AIFF encoding"); //Audit Issue: User marked 'Invalid AIFF encoding' string as Not an Issue string with comment: ''.
                    }
                }
